...
public class LinearLayoutCompat extends ViewGroup {
    ...
    /* renamed from: A */
    private void m1751A(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: k */
    private void m1752k(int i, int i2) {
    ...
    /* renamed from: l */
    private void m1753l(int i, int i2) {
    ...
    /* renamed from: g */
    public void mo1710g(Canvas canvas) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        for (int i5 = 0; i5 < virtualChildCount; i5++) {
            View s = mo1730s(i5);
            if (!(s == null || s.getVisibility() == 8 || !mo1743t(i5))) {
                LayoutParams layoutParams = (LayoutParams) s.getLayoutParams();
                if (b) {
                    i4 = s.getRight() + layoutParams.rightMargin;
                } else {
                    i4 = (s.getLeft() - layoutParams.leftMargin) - this.f1290m;
                }
                mo1723j(canvas, i4);
            }
        }
        if (mo1743t(virtualChildCount)) {
            View s2 = mo1730s(virtualChildCount - 1);
            if (s2 != null) {
    ...
    public int getBaseline() {
        ...
        if (childCount > i2) {
            ...
            if (baseline != -1) {
                int i3 = this.f1281d;
                if (this.f1282e == 1 && (i = this.f1283f & 112) != 48) {
                    if (i == 16) {
                        i3 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f1284g) / 2;
                    } else if (i == 80) {
                        i3 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f1284g;
                    }
                }
                return i3 + ((LayoutParams) childAt.getLayoutParams()).topMargin + baseline;
            } else if (this.f1280c == 0) {
                return -1;
            } else {
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: h */
    public void mo1721h(Canvas canvas) {
        int i;
        int virtualChildCount = getVirtualChildCount();
        for (int i2 = 0; i2 < virtualChildCount; i2++) {
            View s = mo1730s(i2);
            if (!(s == null || s.getVisibility() == 8 || !mo1743t(i2))) {
                mo1722i(canvas, (s.getTop() - ((LayoutParams) s.getLayoutParams()).topMargin) - this.f1291n);
            }
        }
        if (mo1743t(virtualChildCount)) {
            View s2 = mo1730s(virtualChildCount - 1);
            if (s2 == null) {
                i = (getHeight() - getPaddingBottom()) - this.f1291n;
            } else {
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: i */
    public void mo1722i(Canvas canvas, int i) {
        this.f1289l.setBounds(getPaddingLeft() + this.f1293p, i, (getWidth() - getPaddingRight()) - this.f1293p, this.f1291n + i);
        this.f1289l.draw(canvas);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: j */
    public void mo1723j(Canvas canvas, int i) {
        this.f1289l.setBounds(i, getPaddingTop() + this.f1293p, this.f1290m + i, (getHeight() - getPaddingBottom()) - this.f1293p);
        this.f1289l.draw(canvas);
    }
    ...
    /* access modifiers changed from: package-private */
    /* renamed from: p */
    public int mo1727p(View view, int i) {
        return 0;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: q */
    public int mo1728q(View view) {
        return 0;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: r */
    public int mo1729r(View view) {
        return 0;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: s */
    public View mo1730s(int i) {
        return getChildAt(i);
    }
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable != this.f1289l) {
            this.f1289l = drawable;
            boolean z = false;
            if (drawable != null) {
                this.f1290m = drawable.getIntrinsicWidth();
                this.f1291n = drawable.getIntrinsicHeight();
            } else {
                this.f1290m = 0;
                this.f1291n = 0;
            }
    ...
    public void setVerticalGravity(int i) {
        ...
        int i3 = this.f1283f;
        if ((i3 & 112) != i2) {
            this.f1283f = i2 | (i3 & -113);
            requestLayout();
        }
    }

    public void setWeightSum(float f) {
        this.f1285h = Math.max(0.0f, f);
    }
    ...
    /* access modifiers changed from: protected */
    /* renamed from: t */
    public boolean mo1743t(int i) {
        if (i == 0) {
            return (this.f1292o & 1) != 0;
        }
        if (i == getChildCount()) {
            if ((this.f1292o & 4) != 0) {
                return true;
    ...
    public void mo1744u(int r25, int r26, int r27, int r28) {
        /*
            r24 = this;
            r6 = r24
            boolean r0 = androidx.appcompat.widget.C0401l0.m2125b(r24)
            ...
            boolean r12 = r6.f1279b
            int[] r13 = r6.f1287j
            int[] r14 = r6.f1288k
            int r1 = p110m0.C5723u.m25265B(r24)
            int r1 = p110m0.C5705d.m25206b(r2, r1)
            r15 = 2
            r5 = 1
        ...
        L_0x0065:
            ...
            int r0 = r17 * r3
            int r2 = r16 + r0
            android.view.View r0 = r6.mo1730s(r2)
            if (r0 != 0) goto L_0x0078
            int r0 = r6.mo1748y(r2)
            int r1 = r1 + r0
            goto L_0x0129
        L_0x0078:
        ...
        L_0x00fa:
            ...
            r7 = r4
            r4 = r15
            r0.m1751A(r1, r2, r3, r4, r5)
            int r0 = r7.rightMargin
            int r15 = r15 + r0
            r0 = r25
            int r1 = r6.mo1729r(r0)
            int r15 = r15 + r1
            int r10 = r10 + r15
            int r0 = r6.mo1727p(r0, r11)
            int r3 = r18 + r0
            r1 = r10
            goto L_0x0133
        L_0x0127:
        ...
        L_0x013f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.LinearLayoutCompat.mo1744u(int, int, int, int):void");
    }
    ...
    /* renamed from: v */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void mo1745v(int r18, int r19, int r20, int r21) {
        /*
            r17 = this;
            r6 = r17
        ...
        L_0x0049:
            ...
            android.view.View r13 = r6.mo1730s(r12)
            r14 = 1
            if (r13 != 0) goto L_0x0059
            int r1 = r6.mo1748y(r12)
            int r0 = r0 + r1
            goto L_0x00c5
        L_0x0059:
            ...
            r1 = r11
        L_0x0075:
            int r2 = p110m0.C5723u.m25265B(r17)
            int r1 = p110m0.C5705d.m25206b(r1, r2)
            r1 = r1 & 7
        ...
        L_0x00a2:
            ...
            int r15 = r15 + r0
            int r0 = r6.mo1729r(r13)
            int r15 = r15 + r0
            int r16 = r16 + r15
            int r0 = r6.mo1727p(r13, r12)
            int r12 = r12 + r0
            r0 = r16
        L_0x00c5:
            r1 = 1
        ...
        L_0x00c8:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.LinearLayoutCompat.mo1745v(int, int, int, int):void");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: w */
    public void mo1746w(View view, int i, int i2, int i3, int i4, int i5) {
    ...
    /* renamed from: x */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void mo1747x(int r38, int r39) {
        /*
            r37 = this;
            r7 = r37
            r8 = r38
        ...
        L_0x0026:
            ...
            r6[r18] = r5
            r6[r10] = r5
            boolean r4 = r7.f1279b
            boolean r3 = r7.f1286i
        ...
        L_0x0061:
            ...
            android.view.View r6 = r7.mo1730s(r1)
            if (r6 != 0) goto L_0x007f
            int r5 = r7.f1284g
            int r6 = r7.mo1748y(r1)
            int r5 = r5 + r6
            r7.f1284g = r5
        L_0x0076:
            r2 = r1
        ...
        L_0x007f:
            ...
            int r5 = r7.mo1727p(r6, r1)
            int r1 = r1 + r5
            goto L_0x0076
        L_0x008b:
            boolean r5 = r7.mo1743t(r1)
        ...
        L_0x0274:
            ...
            android.view.View r3 = r7.mo1730s(r2)
            if (r3 != 0) goto L_0x0286
            int r3 = r7.f1284g
            int r5 = r7.mo1748y(r2)
            int r3 = r3 + r5
            r7.f1284g = r3
            goto L_0x0293
        L_0x0286:
        ...
        L_0x0303:
            ...
            android.view.View r2 = r7.mo1730s(r10)
        ...
        L_0x035c:
            ...
            android.view.View r14 = r7.mo1730s(r10)
        ...
        L_0x0507:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.LinearLayoutCompat.mo1747x(int, int):void");
    }

    /* access modifiers changed from: package-private */
    /* renamed from: y */
    public int mo1748y(int i) {
        return 0;
    }
    ...
    /* renamed from: z */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void mo1749z(int r34, int r35) {
        /*
            r33 = this;
            r7 = r33
            r8 = r34
        ...
        L_0x002a:
            ...
            android.view.View r4 = r7.mo1730s(r6)
            if (r4 != 0) goto L_0x0047
            int r4 = r7.f1284g
            int r10 = r7.mo1748y(r6)
            int r4 = r4 + r10
            r7.f1284g = r4
            r26 = r11
            r24 = r13
        ...
        L_0x01c5:
            ...
            android.view.View r6 = r7.mo1730s(r4)
            if (r6 != 0) goto L_0x01d7
            int r6 = r7.f1284g
            int r11 = r7.mo1748y(r4)
            int r6 = r6 + r11
            r7.f1284g = r6
            goto L_0x0201
        L_0x01d7:
        ...
        L_0x023f:
            ...
            android.view.View r3 = r7.mo1730s(r1)
        ...
        L_0x0283:
            ...
            android.view.View r13 = r7.mo1730s(r8)
        ...
        L_0x038e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.appcompat.widget.LinearLayoutCompat.mo1749z(int, int):void");
    }
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        this.f1281d = 0;
        this.f1283f = 8388659;
        int[] iArr = C5247j.f23138f1;
        C0384f0 v = C0384f0.m1994v(context, attributeSet, iArr, i, 0);
        C5723u.m25326m0(this, context, iArr, attributeSet, v.mo2112r(), i, 0);
        int k = v.mo2105k(C5247j.f23148h1, -1);
        if (k >= 0) {
            setOrientation(k);
        }
        int k2 = v.mo2105k(C5247j.f23143g1, -1);
        if (k2 >= 0) {
            setGravity(k2);
        }
        boolean a = v.mo2095a(C5247j.f23153i1, true);
        if (!a) {
            setBaselineAligned(a);
        }
        this.f1285h = v.mo2103i(C5247j.f23163k1, -1.0f);
        this.f1280c = v.mo2105k(C5247j.f23158j1, -1);
        this.f1286i = v.mo2095a(C5247j.f23178n1, false);
        setDividerDrawable(v.mo2101g(C5247j.f23168l1));
        this.f1292o = v.mo2105k(C5247j.f23183o1, 0);
        this.f1293p = v.mo2100f(C5247j.f23173m1, 0);
        v.mo2114w();
    }
}
