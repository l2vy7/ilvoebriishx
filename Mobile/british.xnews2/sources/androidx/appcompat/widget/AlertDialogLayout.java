...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    /* renamed from: A */
    private void m1700A(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: B */
    private static int m1701B(View view) {
        int C = C5723u.m25267C(view);
        if (C > 0) {
            return C;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m1701B(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
    ...
    /* renamed from: C */
    private boolean m1702C(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C5243f.f22913V) {
                    view = childAt;
                } else if (id == C5243f.f22925l) {
                    view2 = childAt;
                } else if ((id != C5243f.f22927n && id != C5243f.f22929p) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        m1703l(childCount, i9);
        return true;
    }

    /* renamed from: l */
    private void m1703l(int i, int i2) {
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r2 = r11
        L_0x007e:
            int r3 = p110m0.C5723u.m25265B(r17)
            int r2 = p110m0.C5705d.m25206b(r2, r3)
            r2 = r2 & 7
            r3 = 1
