...
public class RewardedInterstitialAd implements FullScreenAd {
    ...
    @Keep
    public interface RewardedInterstitialAdLoadConfigBuilder extends C3371Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface RewardedInterstitialLoadAdConfig extends C3371Ad.LoadAdConfig {
    }
