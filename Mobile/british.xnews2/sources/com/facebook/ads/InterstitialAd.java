...
public class InterstitialAd implements FullScreenAd {
    ...
    @Keep
    public interface InterstitialAdLoadConfigBuilder extends C3371Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface InterstitialLoadAdConfig extends C3371Ad.LoadAdConfig {
    }
