...
public class RewardedVideoAd implements FullScreenAd {
    ...
    @Keep
    public interface RewardedVideoAdLoadConfigBuilder extends C3371Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface RewardedVideoLoadAdConfig extends C3371Ad.LoadAdConfig {
    }
