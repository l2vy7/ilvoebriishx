...
public final class C11718a {
    ...
    static /* synthetic */ class C11719a {
        ...
        static {
            /*
                int[] r0 = com.ironsource.sdk.p293g.C11703d.C11704a.m51825a()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f52438a = r0
                r1 = 1
                int r2 = com.ironsource.sdk.p293g.C11703d.C11704a.f52400a     // Catch:{ NoSuchFieldError -> 0x000f }
                r2 = 0
                r0[r2] = r1     // Catch:{ NoSuchFieldError -> 0x000f }
            L_0x000f:
                r0 = 2
                int[] r2 = f52438a     // Catch:{ NoSuchFieldError -> 0x0016 }
                int r3 = com.ironsource.sdk.p293g.C11703d.C11704a.f52401b     // Catch:{ NoSuchFieldError -> 0x0016 }
                r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0016 }
            L_0x0016:
                int[] r1 = f52438a     // Catch:{ NoSuchFieldError -> 0x001d }
                int r2 = com.ironsource.sdk.p293g.C11703d.C11704a.f52402c     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 3
                r1[r0] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.ironsource.sdk.p295i.C11718a.C11719a.<clinit>():void");
        }
    }
