...
public final class Encoder {
    ...
    static /* synthetic */ class C104861 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.encoder.Encoder.C104861.<clinit>():void");
        }
    }
    ...
    static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException {
        int i = C104861.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
