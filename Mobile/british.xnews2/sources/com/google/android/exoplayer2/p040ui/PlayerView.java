...
import com.google.android.exoplayer2.p040ui.AspectRatioFrameLayout;
...
public class PlayerView extends FrameLayout implements AdViewProvider {
    ...
    private final class ComponentListener implements Player.Listener, View.OnLayoutChangeListener, View.OnClickListener, PlayerControlView.VisibilityListener {
        ...
        public void onVideoSizeChanged(int i, int i2, int i3, float f) {
            ...
            playerView.onContentAspectRatioChanged(access$400, f2);
        }
    ...
    public void setPlayer(Player player2) {
        ...
        if (player3 != player2) {
            if (player3 != null) {
                ...
                if (player3.isCommandAvailable(21)) {
                    View view = this.surfaceView;
    ...
    public PlayerView(Context context, AttributeSet attributeSet, int i) {
        ...
        int i8 = C6934R.layout.exo_player_view;
        if (attributeSet2 != null) {
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet2, C6934R.styleable.PlayerView, 0, 0);
            try {
                int i9 = C6934R.styleable.PlayerView_shutter_background_color;
                boolean hasValue = obtainStyledAttributes.hasValue(i9);
                int color = obtainStyledAttributes.getColor(i9, 0);
                int resourceId = obtainStyledAttributes.getResourceId(C6934R.styleable.PlayerView_player_layout_id, i8);
                boolean z9 = obtainStyledAttributes.getBoolean(C6934R.styleable.PlayerView_use_artwork, true);
                int resourceId2 = obtainStyledAttributes.getResourceId(C6934R.styleable.PlayerView_default_artwork, 0);
                boolean z10 = obtainStyledAttributes.getBoolean(C6934R.styleable.PlayerView_use_controller, true);
                int i10 = obtainStyledAttributes.getInt(C6934R.styleable.PlayerView_surface_type, 1);
                int i11 = obtainStyledAttributes.getInt(C6934R.styleable.PlayerView_resize_mode, 0);
                int i12 = obtainStyledAttributes.getInt(C6934R.styleable.PlayerView_show_timeout, 5000);
                boolean z11 = obtainStyledAttributes.getBoolean(C6934R.styleable.PlayerView_hide_on_touch, true);
                int i13 = resourceId;
                boolean z12 = obtainStyledAttributes.getBoolean(C6934R.styleable.PlayerView_auto_show, true);
                i6 = obtainStyledAttributes.getInteger(C6934R.styleable.PlayerView_show_buffering, 0);
                int i14 = i11;
                this.keepContentOnPlayerReset = obtainStyledAttributes.getBoolean(C6934R.styleable.PlayerView_keep_content_on_player_reset, this.keepContentOnPlayerReset);
                boolean z13 = obtainStyledAttributes.getBoolean(C6934R.styleable.PlayerView_hide_during_ads, true);
