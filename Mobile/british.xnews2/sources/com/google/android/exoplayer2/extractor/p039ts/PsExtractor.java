...
public final class PsExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = C6714d.f27428a;
    ...
    public void seek(long j, long j2) {
        if ((this.timestampAdjuster.getTimestampOffsetUs() == C6540C.TIME_UNSET) || !(this.timestampAdjuster.getFirstSampleTimestampUs() == 0 || this.timestampAdjuster.getFirstSampleTimestampUs() == j2)) {
