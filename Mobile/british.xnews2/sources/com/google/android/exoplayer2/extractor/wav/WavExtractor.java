...
public final class WavExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = C6716a.f27431a;
    ...
    private static final class PassthroughOutputWriter implements OutputWriter {
        ...
        public PassthroughOutputWriter(ExtractorOutput extractorOutput2, TrackOutput trackOutput2, WavHeader wavHeader, String str, int i) throws ParserException {
            ...
            if (wavHeader.blockSize == i2) {
                ...
                this.format = new Format.Builder().setSampleMimeType(str).setAverageBitrate(i4).setPeakBitrate(i4).setMaxInputSize(max).setChannelCount(wavHeader.numChannels).setSampleRate(wavHeader.frameRateHz).setPcmEncoding(i).build();
                return;
            }
            int i5 = wavHeader.blockSize;
        ...
        public boolean sampleData(ExtractorInput extractorInput, long j) throws IOException {
            ...
            while (j3 > 0 && (i = this.pendingOutputBytes) < (i2 = this.targetSampleSizeBytes)) {
                int sampleData = this.trackOutput.sampleData((DataReader) extractorInput, (int) Math.min((long) (i2 - i), j3), true);
                if (sampleData == -1) {
                    j3 = 0;
                } else {
            ...
            if (i4 > 0) {
                long scaleLargeTimestamp = this.startTimeUs + Util.scaleLargeTimestamp(this.outputFrameCount, 1000000, (long) wavHeader.frameRateHz);
                int i5 = i4 * i3;
                int i6 = this.pendingOutputBytes - i5;
                this.trackOutput.sampleMetadata(scaleLargeTimestamp, 1, i5, i6, (TrackOutput.CryptoData) null);
