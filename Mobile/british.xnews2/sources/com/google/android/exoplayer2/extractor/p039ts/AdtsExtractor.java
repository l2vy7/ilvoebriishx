...
import com.google.android.exoplayer2.extractor.p039ts.TsPayloadReader;
...
public final class AdtsExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = C6713c.f27427a;
    ...
    private void calculateAverageFrameSize(com.google.android.exoplayer2.extractor.ExtractorInput r10) throws java.io.IOException {
        ...
        L_0x001a:
            ...
            boolean r6 = com.google.android.exoplayer2.extractor.p039ts.AdtsReader.isAdtsSyncWord(r6)     // Catch:{ EOFException -> 0x0076 }
        ...
        L_0x0084:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.extractor.p039ts.AdtsExtractor.calculateAverageFrameSize(com.google.android.exoplayer2.extractor.ExtractorInput):void");
    }
    ...
    private void maybeOutputSeekMap(long j, boolean z, boolean z2) {
        if (!this.hasOutputSeekMap) {
            ...
            if (!z3 || this.reader.getSampleDurationUs() != C6540C.TIME_UNSET || z2) {
                if (!z3 || this.reader.getSampleDurationUs() == C6540C.TIME_UNSET) {
                    this.extractorOutput.seekMap(new SeekMap.Unseekable(C6540C.TIME_UNSET));
                } else {
    ...
    public boolean sniff(com.google.android.exoplayer2.extractor.ExtractorInput r9) throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r5 = com.google.android.exoplayer2.extractor.p039ts.AdtsReader.isAdtsSyncWord(r5)
        ...
        L_0x0059:
            ...
            goto L_0x0008
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.extractor.p039ts.AdtsExtractor.sniff(com.google.android.exoplayer2.extractor.ExtractorInput):boolean");
    }
