...
public final class FlvExtractor implements Extractor {
    public static final ExtractorsFactory FACTORY = C6698a.f27414a;
    ...
    private long getCurrentTimestampUs() {
        ...
        if (this.metadataReader.getDurationUs() == C6540C.TIME_UNSET) {
            return 0;
        }
    ...
    public boolean sniff(ExtractorInput extractorInput) throws IOException {
        ...
        this.scratch.setPosition(0);
        if ((this.scratch.readUnsignedShort() & IronSourceConstants.INTERSTITIAL_DAILY_CAPPED) != 0) {
            return false;
        }
