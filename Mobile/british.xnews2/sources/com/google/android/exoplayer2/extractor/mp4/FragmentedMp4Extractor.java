...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = C6704a.f27420a;
    ...
    private static DrmInitData getDrmInitDataFromAtoms(List<Atom.LeafAtom> list) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (leafAtom.type == 1886614376) {
                ...
                if (parseUuid == null) {
                    Log.m19797w(TAG, "Skipped pssh atom (failed to extract uuid)");
                } else {
    ...
    private void onEmsgLeafAtomRead(com.google.android.exoplayer2.util.ParsableByteArray r27) {
        ...
        L_0x000a:
            ...
            com.google.android.exoplayer2.util.Log.m19797w(r2, r1)
            return
        L_0x003a:
    ...
    private void onMoofContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        if (this.pendingSeekTimeUs != C6540C.TIME_UNSET) {
            int size2 = this.trackBundles.size();
            for (int i2 = 0; i2 < size2; i2++) {
                this.trackBundles.valueAt(i2).seek(this.pendingSeekTimeUs);
            }
            this.pendingSeekTimeUs = C6540C.TIME_UNSET;
        }
    }
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> parseTraks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), j, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new C6705b(this));
        int size2 = parseTraks.size();
        if (this.trackBundles.size() == 0) {
            while (i < size2) {
                TrackSampleTable trackSampleTable = parseTraks.get(i);
                Track track = trackSampleTable.track;
                this.trackBundles.put(track.f27419id, new TrackBundle(this.extractorOutput.track(i, track.type), trackSampleTable, getDefaultSampleValues(sparseArray, track.f27419id)));
        ...
        while (i < size2) {
            ...
            this.trackBundles.get(track2.f27419id).reset(trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f27419id));
            i++;
        }
    }
            ...
            if (parsableByteArray.readInt() == 1) {
                ...
                if (parsableByteArray2.readUnsignedInt() == 1) {
                    ...
                    if (z) {
                        ...
                        trackFragment2.trackEncryptionBox = new TrackEncryptionBox(z, str, readUnsignedByte2, bArr2, i3, i4, bArr);
                        return;
                    }
                    return;
                }
    ...
    private boolean readSample(ExtractorInput extractorInput) throws IOException {
        ...
        if (trackBundle == null) {
            ...
            if (currentSampleOffset < 0) {
                Log.m19797w(TAG, "Ignoring negative offset to sample data.");
        ...
        if (this.parserState == 3) {
            ...
            if (trackBundle.currentSampleIndex < trackBundle.firstSampleToOutputIndex) {
                extractorInput2.skipFully(currentSampleSize);
            ...
            while (this.sampleBytesWritten < this.sampleSize) {
                ...
                if (i9 == 0) {
                    ...
                    if (this.processSeiNalUnitPayload) {
                        ...
                        i = trackOutput.sampleData((DataReader) extractorInput2, i9, false);
                    }
    ...
    public FragmentedMp4Extractor(int i, TimestampAdjuster timestampAdjuster2, Track track, List<Format> list, TrackOutput trackOutput) {
        ...
        this.pendingSeekTimeUs = C6540C.TIME_UNSET;
        this.segmentIndexEarliestPresentationTimeUs = C6540C.TIME_UNSET;
