...
public final class FlacExtractor implements Extractor {
    ...
    public static final ExtractorsFactory FACTORY = C6697b.f27413a;
    ...
    private SeekMap getSeekMap(long j, long j2) {
        ...
        if (flacStreamMetadata2.seekTable != null) {
            return new FlacSeekTableSeekMap(flacStreamMetadata2, j);
        }
        if (j2 == -1 || flacStreamMetadata2.totalSamples <= 0) {
