...
public final class Cea608Decoder extends CeaDecoder {
    ...
    public Cea608Decoder(String str, int i, long j) {
        ...
        if (i == 1) {
            ...
            Log.m19797w(TAG, "Invalid channel. Defaulting to CC1.");
            this.selectedChannel = 0;
            this.selectedField = 0;
        } else {
            this.selectedChannel = 1;
        ...
        this.lastCueUpdateUs = C6540C.TIME_UNSET;
    }
    ...
    private boolean shouldClearStuckCaptions() {
        if (this.validDataChannelTimeoutUs == C6540C.TIME_UNSET || this.lastCueUpdateUs == C6540C.TIME_UNSET || getPositionUs() - this.lastCueUpdateUs < this.validDataChannelTimeoutUs) {
            return false;
        }
        return true;
    }
