...
public final class WebvttCueParser {
    ...
    private static class Element {
        ...
        public static final Comparator<Element> BY_START_POSITION_ASC = C6913a.f27612b;
        /* access modifiers changed from: private */
                ...
                if (i != 3) {
                    if (i != 4) {
                        if (i != 5) {
                            ...
                            sb.append(i);
                            Log.m19797w(WebvttCueParser.TAG, sb.toString());
                            return null;
                        }
                    }
                }
    ...
    private static int parseLineAnchor(String str) {
        ...
        switch (c) {
            ...
            case 3:
                return 0;
            default:
                Log.m19797w(TAG, str.length() != 0 ? "Invalid anchor value: ".concat(str) : new String("Invalid anchor value: "));
    ...
    private static int parseTextAlignment(String str) {
        ...
        switch (c) {
            ...
            case 5:
                return 1;
            default:
                Log.m19797w(TAG, str.length() != 0 ? "Invalid alignment value: ".concat(str) : new String("Invalid alignment value: "));
                return 2;
        }
    }
    ...
    private static int parseVerticalAttribute(String str) {
        ...
        Log.m19797w(TAG, str.length() != 0 ? "Invalid 'vertical' value: ".concat(str) : new String("Invalid 'vertical' value: "));
        return Integer.MIN_VALUE;
    }
    ...
    private static void parseCueSettingsList(String str, WebvttCueInfoBuilder webvttCueInfoBuilder) {
        ...
        while (matcher.find()) {
            ...
            try {
                ...
                Log.m19797w(TAG, valueOf.length() != 0 ? "Skipping bad cue setting: ".concat(valueOf) : new String("Skipping bad cue setting: "));
            }
        }
    }
    ...
    private static WebvttCueInfo parseCue(String str, Matcher matcher, ParsableByteArray parsableByteArray, List<WebvttCssStyle> list) {
        ...
        try {
            ...
            String valueOf = String.valueOf(matcher.group());
            Log.m19797w(TAG, valueOf.length() != 0 ? "Skipping cue with bad header: ".concat(valueOf) : new String("Skipping cue with bad header: "));
            return null;
        }
    }
}
