...
final class PlaybackInfo {
    ...
    public PlaybackInfo(Timeline timeline2, MediaSource.MediaPeriodId mediaPeriodId, long j, long j2, int i, ExoPlaybackException exoPlaybackException, boolean z, TrackGroupArray trackGroupArray, TrackSelectorResult trackSelectorResult2, List<Metadata> list, MediaSource.MediaPeriodId mediaPeriodId2, boolean z2, int i2, PlaybackParameters playbackParameters2, long j3, long j4, long j5, boolean z3, boolean z4) {
    ...
    public static PlaybackInfo createDummy(TrackSelectorResult trackSelectorResult2) {
        ...
        return new PlaybackInfo(timeline2, mediaPeriodId, C6540C.TIME_UNSET, 0, 1, (ExoPlaybackException) null, false, TrackGroupArray.EMPTY, trackSelectorResult2, C4766t.m21978E(), mediaPeriodId, false, 0, PlaybackParameters.DEFAULT, 0, 0, 0, false, false);
    }
    ...
    public PlaybackInfo copyWithNewPosition(MediaSource.MediaPeriodId mediaPeriodId, long j, long j2, long j3, long j4, TrackGroupArray trackGroupArray, TrackSelectorResult trackSelectorResult2, List<Metadata> list) {
        ...
        Timeline timeline2 = this.timeline;
        return new PlaybackInfo(timeline2, mediaPeriodId, j2, j3, this.playbackState, this.playbackError, this.isLoading, trackGroupArray2, trackSelectorResult3, list2, this.loadingMediaPeriodId, this.playWhenReady, this.playbackSuppressionReason, this.playbackParameters, this.bufferedPositionUs, j4, j5, this.offloadSchedulingEnabled, this.sleepingForOffload);
    }
