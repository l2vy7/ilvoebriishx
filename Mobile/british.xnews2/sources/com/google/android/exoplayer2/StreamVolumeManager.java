...
final class StreamVolumeManager {
    ...
    private final class VolumeChangeReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            StreamVolumeManager.this.eventHandler.post(new C7038w0(StreamVolumeManager.this));
        }
    }
    ...
    public StreamVolumeManager(Context context, Handler handler, Listener listener2) {
        ...
        try {
            ...
            Log.m19798w(TAG, "Error registering stream volume receiver", e);
        }
    }
    ...
    public void release() {
        ...
        if (volumeChangeReceiver != null) {
            try {
                ...
                Log.m19798w(TAG, "Error unregistering stream volume receiver", e);
            }
            this.receiver = null;
        }
    }
