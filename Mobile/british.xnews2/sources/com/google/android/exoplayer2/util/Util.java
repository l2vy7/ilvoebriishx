...
public final class Util {
    ...
    public static Uri fixSmoothStreamingIsmManifestUri(Uri uri) {
        ...
        Matcher matcher = ISM_URL_PATTERN.matcher(C10995b.m49338e(path));
    ...
    public static String fromUtf8Bytes(byte[] bArr) {
        return new String(bArr, C11001d.f49947c);
    }
    ...
    public static String getCountryCode(Context context) {
        ...
        if (!(context == null || (telephonyManager = (TelephonyManager) context.getSystemService("phone")) == null)) {
            ...
            if (!TextUtils.isEmpty(networkCountryIso)) {
                return C10995b.m49339f(networkCountryIso);
            }
        }
        return C10995b.m49339f(Locale.getDefault().getCountry());
    }
    ...
    public static UUID getDrmUuid(String str) {
        ...
        switch (e.hashCode()) {
            case -1860423953:
                if (e.equals("playready")) {
                    c = 0;
                    break;
                }
                break;
            case -1400551171:
                if (e.equals("widevine")) {
                    c = 1;
                    break;
                }
                break;
            case 790309106:
                if (e.equals("clearkey")) {
                    c = 2;
                    break;
                }
                break;
        ...
        switch (c) {
            case 0:
                return C6540C.PLAYREADY_UUID;
            case 1:
                return C6540C.WIDEVINE_UUID;
            case 2:
                return C6540C.CLEARKEY_UUID;
            default:
                try {
    ...
    private static String getSystemProperty(String str) {
        try {
            ...
            Log.m19794e(TAG, valueOf.length() != 0 ? "Failed to read system property ".concat(valueOf) : new String("Failed to read system property "), e);
            return null;
        }
    }
    ...
    public static byte[] getUtf8Bytes(String str) {
        return str.getBytes(C11001d.f49947c);
    }
    ...
    public static ExecutorService newSingleThreadExecutor(String str) {
        return Executors.newSingleThreadExecutor(new C7015f(str));
    }
    ...
    public static String normalizeLanguageCode(String str) {
        ...
        String e = C10995b.m49338e(str);
        String str2 = splitAtFirst(e, "-")[0];
        if (languageTagReplacementMap == null) {
            languageTagReplacementMap = createIsoLanguageReplacementMap();
        }
        String str3 = languageTagReplacementMap.get(str2);
        if (str3 != null) {
            String valueOf = String.valueOf(e.substring(str2.length()));
            e = valueOf.length() != 0 ? str3.concat(valueOf) : new String(str3);
            str2 = str3;
        }
        return ("no".equals(str2) || "i".equals(str2) || "zh".equals(str2)) ? maybeReplaceLegacyLanguageTags(e) : e;
    }
    ...
    public static String fromUtf8Bytes(byte[] bArr, int i, int i2) {
        return new String(bArr, i, i2, C11001d.f49947c);
    }
    ...
    public static Point getCurrentDisplayModeSize(Context context, Display display) {
        ...
        if (i <= 29 && display.getDisplayId() == 0 && isTv(context)) {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                String valueOf = String.valueOf(str);
                Log.m19793e(TAG, valueOf.length() != 0 ? "Invalid display size: ".concat(valueOf) : new String("Invalid display size: "));
            }
        }
    ...
    public static int inferContentType(Uri uri) {
        String scheme = uri.getScheme();
        if (scheme != null && C10995b.m49334a("rtsp", scheme)) {
            return 3;
        }
        String path = uri.getPath();
        if (path == null) {
    ...
    public static int inferContentType(String str) {
        ...
        Matcher matcher = ISM_URL_PATTERN.matcher(e);
        if (!matcher.matches()) {
            return 4;
        }
