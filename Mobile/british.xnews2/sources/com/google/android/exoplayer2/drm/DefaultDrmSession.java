...
class DefaultDrmSession implements DrmSession {
    ...
    private class RequestHandler extends Handler {
        ...
        public void handleMessage(android.os.Message r6) {
            ...
            L_0x002f:
                ...
                com.google.android.exoplayer2.util.Log.m19798w(r2, r3, r1)
                goto L_0x0040
            L_0x0038:
                r1 = move-exception
    ...
    private long getLicenseDurationRemainingSec() {
        if (!C6540C.WIDEVINE_UUID.equals(this.uuid)) {
    ...
    private void onError(Exception exc) {
        ...
        Log.m19794e(TAG, "DRM session error", exc);
        dispatchEvent(new C6657b(exc));
        if (this.state != 4) {
            this.state = 1;
        }
    }
