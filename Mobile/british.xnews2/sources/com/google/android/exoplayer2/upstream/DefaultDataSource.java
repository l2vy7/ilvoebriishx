    ...
    private DataSource getRtmpDataSource() {
        if (this.rtmpDataSource == null) {
            ...
            try {
                ...
                DataSource newInstance = cls.getConstructor(new Class[0]).newInstance(new Object[0]);
                this.rtmpDataSource = newInstance;
                addListenersToDataSource(newInstance);
            } catch (ClassNotFoundException unused) {
                Log.m19797w(TAG, "Attempting to play RTMP stream without depending on the RTMP extension");
            } catch (Exception e) {
