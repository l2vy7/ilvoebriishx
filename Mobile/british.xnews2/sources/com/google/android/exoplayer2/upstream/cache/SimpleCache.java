...
public final class SimpleCache implements Cache {
    ...
    public void initialize() {
        ...
        if (loadUid == -1) {
            try {
                ...
                Log.m19794e(TAG, sb4, e2);
                this.initializationException = new Cache.CacheException(sb4, e2);
                return;
            }
        }
        try {
            ...
            try {
                ...
                Log.m19794e(TAG, "Storing index file failed", e3);
            }
            ...
            Log.m19794e(TAG, sb6, e4);
            this.initializationException = new Cache.CacheException(sb6, e4);
        }
    }
        ...
        if (cachedContent != null && cachedContent.removeSpan(cacheSpan)) {
            ...
            if (this.fileIndex != null) {
                ...
                try {
                    ...
                    Log.m19797w(TAG, valueOf.length() != 0 ? "Failed to remove file index entry for: ".concat(valueOf) : new String("Failed to remove file index entry for: "));
                }
            }
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        if (cacheFileMetadataIndex != null) {
            try {
                ...
                Log.m19797w(TAG, "Failed to update index with new touch timestamp.");
            }
        } else {
            z = true;
        }
    ...
    public synchronized void release() {
        if (!this.released) {
            ...
            try {
                ...
                try {
                    Log.m19794e(TAG, "Storing index file failed", e);
                    unlockFolder(this.cacheDir);
                } catch (Throwable th) {
                    unlockFolder(this.cacheDir);
                    this.released = true;
    ...
    public synchronized File startFile(String str, long j, long j2) throws Cache.CacheException {
        ...
        return SimpleCacheSpan.getCacheFile(file, cachedContent.f27661id, j, System.currentTimeMillis());
    }
