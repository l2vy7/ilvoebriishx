...
public final class PlaybackStats {
    ...
    public long getMeanElapsedTimeMs() {
        return this.playbackCount == 0 ? C6540C.TIME_UNSET : getTotalElapsedTimeMs() / ((long) this.playbackCount);
    }
    ...
    public long getMeanJoinTimeMs() {
        ...
        return i == 0 ? C6540C.TIME_UNSET : this.totalValidJoinTimeMs / ((long) i);
    }
    ...
    public long getMeanSingleSeekTimeMs() {
        return this.totalSeekCount == 0 ? C6540C.TIME_UNSET : getTotalSeekTimeMs() / ((long) this.totalSeekCount);
    }
