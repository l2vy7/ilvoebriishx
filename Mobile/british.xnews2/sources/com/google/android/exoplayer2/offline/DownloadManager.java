...
public final class DownloadManager {
    ...
    public DownloadManager(Context context2, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context2, databaseProvider, cache, factory, C6791a.f27485b);
    }
    ...
    public DownloadManager(Context context2, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler createHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new C6800j(this));
        ...
        this.internalHandler = internalHandler2;
        C6801k kVar = new C6801k(this);
        this.requirementsListener = kVar;
        RequirementsWatcher requirementsWatcher2 = new RequirementsWatcher(context2, kVar, DEFAULT_REQUIREMENTS);
        this.requirementsWatcher = requirementsWatcher2;
    ...
    private static final class InternalHandler extends Handler {
        ...
        private void addDownload(DownloadRequest downloadRequest, int i) {
            Download download = getDownload(downloadRequest.f27483id, true);
        ...
        private Download getDownload(String str, boolean z) {
            ...
            try {
                ...
                Log.m19794e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to load download: ".concat(valueOf) : new String("Failed to load download: "), e);
                return null;
            }
        }
        ...
        private int getDownloadIndex(String str) {
            for (int i = 0; i < this.downloads.size(); i++) {
                if (this.downloads.get(i).request.f27483id.equals(str)) {
                    return i;
                }
            }
            return -1;
        ...
        private void initialize(int i) {
            ...
            try {
                ...
                Log.m19794e(DownloadManager.TAG, "Failed to load index.", e);
        ...
        private void onContentLengthChanged(Task task, long j) {
            Download download = (Download) Assertions.checkNotNull(getDownload(task.request.f27483id, false));
        ...
        private void onDownloadTaskStopped(Download download, Exception exc) {
            ...
            this.downloads.remove(getDownloadIndex(download3.request.f27483id));
            try {
                this.downloadIndex.putDownload(download3);
            } catch (IOException e) {
                Log.m19794e(DownloadManager.TAG, "Failed to update index.", e);
            }
        ...
        private void onRemoveTaskStopped(Download download) {
            ...
            this.downloads.remove(getDownloadIndex(download.request.f27483id));
            try {
                this.downloadIndex.removeDownload(download.request.f27483id);
            } catch (IOException unused) {
                Log.m19793e(DownloadManager.TAG, "Failed to remove from database");
            }
        ...
        private void onTaskStopped(Task task) {
            String str = task.request.f27483id;
            ...
            if (access$400 != null) {
                ...
                Log.m19794e(DownloadManager.TAG, sb.toString(), access$400);
            }
        ...
        private Download putDownload(Download download) {
            ...
            int downloadIndex2 = getDownloadIndex(download.request.f27483id);
            if (downloadIndex2 == -1) {
                this.downloads.add(download);
                Collections.sort(this.downloads, C6802l.f27497b);
            } else {
        ...
        private void removeAllDownloads() {
            ...
            try {
                ...
                Log.m19793e(DownloadManager.TAG, "Failed to load downloads.");
            } catch (Throwable th) {
                th.addSuppressed(th);
            }
            for (int i = 0; i < this.downloads.size(); i++) {
        ...
        private void removeDownload(String str) {
            ...
            if (download == null) {
                String valueOf = String.valueOf(str);
                Log.m19793e(DownloadManager.TAG, valueOf.length() != 0 ? "Failed to remove nonexistent download: ".concat(valueOf) : new String("Failed to remove nonexistent download: "));
                return;
            }
        ...
        private void setStopReason(String str, int i) {
            if (str == null) {
                ...
                try {
                    ...
                    Log.m19794e(DownloadManager.TAG, "Failed to set manual stop reason", e);
                }
            } else {
                ...
                if (download != null) {
                    ...
                    try {
                        ...
                        Log.m19794e(DownloadManager.TAG, str.length() != 0 ? "Failed to set manual stop reason: ".concat(str) : new String("Failed to set manual stop reason: "), e2);
                    }
                }
            }
            syncTasks();
        ...
        private Task syncQueuedDownload(Task task, Download download) {
            if (task != null) {
                ...
                this.activeTasks.put(putDownloadWithState.request.f27483id, task2);
        ...
        private void syncRemovingDownload(Task task, Download download) {
            if (task == null) {
                ...
                this.activeTasks.put(download.request.f27483id, task2);
                task2.start();
        ...
        private void syncTasks() {
            ...
            for (int i2 = 0; i2 < this.downloads.size(); i2++) {
                ...
                Task task = this.activeTasks.get(download.request.f27483id);
