...
public final class DownloadRequest implements Parcelable {
    ...
    public DownloadRequest copyWithKeySetId(byte[] bArr) {
        return new DownloadRequest(this.f27483id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List list;
        Assertions.checkArgument(this.f27483id.equals(downloadRequest.f27483id));
        ...
        return new DownloadRequest(this.f27483id, downloadRequest.uri, downloadRequest.mimeType, list, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }
    ...
    public final int hashCode() {
        int hashCode = ((this.f27483id.hashCode() * 31 * 31) + this.uri.hashCode()) * 31;
    ...
    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f27483id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).setDrmKeySetId(this.keySetId).build();
    }

    public String toString() {
        String str = this.mimeType;
        String str2 = this.f27483id;
    ...
    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeString(this.f27483id);
    ...
    DownloadRequest(Parcel parcel) {
        this.f27483id = (String) Util.castNonNull(parcel.readString());
