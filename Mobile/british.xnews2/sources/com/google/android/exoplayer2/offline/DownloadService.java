    ...
    private static final class DownloadManagerHelper implements DownloadManager.Listener {
        ...
        private void restartService() {
            ...
            try {
                ...
                Log.m19797w(DownloadService.TAG, "Failed to restart DownloadService (process is idle).");
            }
        }
            ...
            if (this.scheduler != null) {
                if (this.downloadManager.isWaitingForRequirements()) {
                    ...
                    if (!this.scheduler.schedule(this.downloadManager.getRequirements(), packageName, DownloadService.ACTION_RESTART)) {
                        Log.m19793e(DownloadService.TAG, "Scheduling downloads failed.");
                        return;
                    }
                    return;
                }
        ...
        public void attachService(DownloadService downloadService2) {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new C6804n(this, downloadService2));
            }
        }
        ...
        public void onDownloadChanged(DownloadManager downloadManager2, Download download, Exception exc) {
            ...
            if (serviceMayNeedRestart() && DownloadService.needsStartedService(download.state)) {
                Log.m19797w(DownloadService.TAG, "DownloadService wasn't running. Restarting.");
                restartService();
            }
        }
        ...
        public /* synthetic */ void onDownloadsPausedChanged(DownloadManager downloadManager2, boolean z) {
            C6803m.m28578c(this, downloadManager2, z);
        }
        ...
        public /* synthetic */ void onRequirementsStateChanged(DownloadManager downloadManager2, Requirements requirements, int i) {
            C6803m.m28581f(this, downloadManager2, requirements, i);
        }
    ...
    private final class ForegroundNotificationUpdater {
        ...
        public void update() {
            ...
            if (this.periodicUpdatesStarted) {
                ...
                this.handler.postDelayed(new C6805o(this), this.updateInterval);
            }
        }
        ...
        switch (c) {
            case 0:
                ...
                if (downloadRequest != null) {
                    ...
                    Log.m19793e(TAG, "Ignored ADD_DOWNLOAD: Missing download_request extra");
                    break;
                }
            case 1:
                downloadManager2.resumeDownloads();
            ...
            case 4:
                ...
                if (requirements != null) {
                    ...
                    Log.m19793e(TAG, "Ignored SET_REQUIREMENTS: Missing requirements extra");
                    break;
                }
            case 5:
            ...
            case 6:
                if (((Intent) Assertions.checkNotNull(intent)).hasExtra(KEY_STOP_REASON)) {
                    ...
                    Log.m19793e(TAG, "Ignored SET_STOP_REASON: Missing stop_reason extra");
                    break;
                }
            case 8:
                if (str != null) {
                    ...
                    Log.m19793e(TAG, "Ignored REMOVE_DOWNLOAD: Missing content_id extra");
                    break;
                }
            default:
                Log.m19793e(TAG, str2.length() != 0 ? "Ignored unrecognized action: ".concat(str2) : new String("Ignored unrecognized action: "));
                break;
        }
