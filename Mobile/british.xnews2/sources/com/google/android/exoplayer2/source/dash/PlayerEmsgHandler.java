...
public final class PlayerEmsgHandler implements Handler.Callback {
    ...
    public final class PlayerTrackEmsgHandler implements TrackOutput {
        ...
        private long maxLoadedChunkEndTimeUs = C6540C.TIME_UNSET;
        ...
        private void parsePlayerEmsgEvent(long j, EventMessage eventMessage) {
            ...
            if (access$200 != C6540C.TIME_UNSET) {
        ...
        public void onChunkLoadCompleted(Chunk chunk) {
            ...
            if (j == C6540C.TIME_UNSET || chunk.endTimeUs > j) {
        ...
        public boolean onChunkLoadError(Chunk chunk) {
            long j = this.maxLoadedChunkEndTimeUs;
            return PlayerEmsgHandler.this.onChunkLoadError(j != C6540C.TIME_UNSET && j < chunk.startTimeUs);
        }
