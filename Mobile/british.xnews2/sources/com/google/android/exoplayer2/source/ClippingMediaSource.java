...
public final class ClippingMediaSource extends CompositeMediaSource<Void> {
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public ClippingTimeline(Timeline timeline, long j, long j2) throws IllegalClippingException {
            ...
            if (timeline.getPeriodCount() == 1) {
                ...
                if (window.isPlaceholder || max == 0 || window.isSeekable) {
                    ...
                    this.startUs = max;
                    this.endUs = max2;
                    this.durationUs = max2 == C6540C.TIME_UNSET ? -9223372036854775807L : max2 - max;
                    if (window.isDynamic && (max2 == C6540C.TIME_UNSET || (j3 != C6540C.TIME_UNSET && max2 == j3))) {
                        z = true;
                    }
                    this.isDynamic = z;
                    return;
        ...
        public Timeline.Period getPeriod(int i, Timeline.Period period, boolean z) {
            ...
            return period.set(period.f27198id, period.uid, 0, j == C6540C.TIME_UNSET ? -9223372036854775807L : j - positionInWindowUs, positionInWindowUs);
        }
        ...
        public Timeline.Window getWindow(int i, Timeline.Window window, long j) {
            ...
            long usToMs = C6540C.usToMs(this.startUs);
    ...
    public static final class IllegalClippingException extends IOException {
        ...
        private static String getReasonDescription(int i) {
            return i != 0 ? i != 1 ? i != 2 ? C3791bd.UNKNOWN_CONTENT_TYPE : "start exceeds end" : "not seekable to start" : "invalid period count";
        }
    }
