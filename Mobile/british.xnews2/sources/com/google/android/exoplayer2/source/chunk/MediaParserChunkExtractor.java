...
public final class MediaParserChunkExtractor implements ChunkExtractor {
    public static final ChunkExtractor.Factory FACTORY = C6840b.f27531a;
    ...
    public MediaParserChunkExtractor(int i, Format format, List<Format> list) {
        ...
        this.pendingSeekUs = C6540C.TIME_UNSET;
    }
    ...
    public static /* synthetic */ ChunkExtractor lambda$static$0(int i, Format format, boolean z, List list, TrackOutput trackOutput) {
        ...
        Log.m19797w(TAG, "Ignoring an unsupported text track.");
        return null;
    }
    ...
    private void maybeExecutePendingSeek() {
        ...
        if (j != C6540C.TIME_UNSET && dummySeekMap != null) {
