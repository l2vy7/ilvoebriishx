...
import com.google.common.collect.C4727j0;
...
public final class MergingMediaSource extends CompositeMediaSource<Integer> {
    ...
    private final C4727j0<Object, ClippingMediaPeriod> clippedMediaPeriods;
    ...
    private void updateClippedDuration() {
        ...
        for (int i = 0; i < this.periodCount; i++) {
            ...
            while (true) {
                ...
                if (durationUs != C6540C.TIME_UNSET) {
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        if (this.clipDurations) {
            ...
            Iterator<Map.Entry<Object, ClippingMediaPeriod>> it = this.clippedMediaPeriods.mo19516a().iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
    ...
    public MergingMediaSource(boolean z, boolean z2, CompositeSequenceableLoaderFactory compositeSequenceableLoaderFactory2, MediaSource... mediaSourceArr) {
        ...
        this.clippedMediaPeriods = C10394k0.m47932a().mo41838a().mo41837e();
    }
}
