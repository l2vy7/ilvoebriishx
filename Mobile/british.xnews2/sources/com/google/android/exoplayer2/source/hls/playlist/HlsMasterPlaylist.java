...
public final class HlsMasterPlaylist extends HlsPlaylist {
    ...
    public static final class Variant {
        ...
        public static Variant createMediaPlaylistVariantUrl(Uri uri) {
            return new Variant(uri, new Format.Builder().setId(SessionDescription.SUPPORTED_SDP_VERSION).setContainerMimeType(MimeTypes.APPLICATION_M3U8).build(), (String) null, (String) null, (String) null, (String) null);
        }
