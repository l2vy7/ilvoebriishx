...
import com.google.android.exoplayer2.extractor.p039ts.Ac3Extractor;
import com.google.android.exoplayer2.extractor.p039ts.Ac4Extractor;
import com.google.android.exoplayer2.extractor.p039ts.AdtsExtractor;
import com.google.android.exoplayer2.extractor.p039ts.DefaultTsPayloadReaderFactory;
...
public final class DefaultHlsExtractorFactory implements HlsExtractorFactory {
    ...
    private static void addFileTypeIfValidAndNotPresent(int i, List<Integer> list) {
        if (C11054c.m49462f(DEFAULT_EXTRACTOR_ORDER, i) != -1 && !list.contains(Integer.valueOf(i))) {
