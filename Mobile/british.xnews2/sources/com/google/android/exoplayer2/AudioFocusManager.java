...
final class AudioFocusManager {
    ...
    private class AudioFocusListener implements AudioManager.OnAudioFocusChangeListener {
        ...
        public void onAudioFocusChange(int i) {
            this.eventHandler.post(new C6554a(this, i));
        }
    }
    ...
    private static int convertAudioAttributesToFocusGain(AudioAttributes audioAttributes2) {
        ...
        switch (i) {
            case 0:
                Log.m19797w(TAG, "Specify a proper usage in the audio attributes for audio focus handling. Using AUDIOFOCUS_GAIN by default.");
                return 1;
            case 1:
            case 14:
                return 1;
