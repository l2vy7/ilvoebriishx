...
public final class zzby {
    ...
    /* renamed from: a */
    private static JSONObject m28829a(JSONObject jSONObject, String[] strArr) {
    ...
    /* renamed from: b */
    private static void m28830b(JsonWriter jsonWriter, Object obj) throws IOException {
        if (obj == null) {
        ...
        } else if (obj instanceof nr2) {
            zzj(jsonWriter, ((nr2) obj).f36098d);
        } else if (obj instanceof Map) {
            jsonWriter.beginObject();
            for (Map.Entry entry : ((Map) obj).entrySet()) {
                Object key = entry.getKey();
                if (key instanceof String) {
                    m28830b(jsonWriter.name((String) key), entry.getValue());
                }
            }
                ...
                if (opt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (obj == null) {
                            ...
                            co0.zzj(valueOf.length() != 0 ? "Expected JSONArray with at least 1 non-null element for key:".concat(valueOf) : new String("Expected JSONArray with at least 1 non-null element for key:"));
                            ...
                            co0.zzj(String.format("JSONArray with unsupported type %s for key:%s", new Object[]{obj.getClass().getCanonicalName(), next}));
                        }
                    }
                    ...
                    co0.zzj(valueOf2.length() != 0 ? "Unsupported type for key:".concat(valueOf2) : new String("Unsupported type for key:"));
                }
            }
        }
        return bundle;
    ...
    public static String zzb(String str, JSONObject jSONObject, String... strArr) {
        JSONObject a = m28829a(jSONObject, strArr);
        if (a == null) {
            return "";
        }
        return a.optString(strArr[0], "");
    }
    ...
    public static String zzl(nr2 nr2) {
        if (nr2 == null) {
            return null;
        }
        ...
        try {
            ...
            m28830b(jsonWriter, nr2);
            jsonWriter.close();
            return stringWriter.toString();
        } catch (IOException e) {
            co0.zzh("Error when writing JSON.", e);
            return null;
        }
    }
}
