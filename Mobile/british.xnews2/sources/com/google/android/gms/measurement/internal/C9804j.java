...
public final class C9804j {
    ...
    static void m45181a(com.google.android.gms.measurement.internal.C4667d3 r14, android.database.sqlite.SQLiteDatabase r15, java.lang.String r16, java.lang.String r17, java.lang.String r18, java.lang.String[] r19) throws android.database.sqlite.SQLiteException {
        /*
            r9 = r15
            r10 = r16
            r11 = r19
        ...
        L_0x002f:
            ...
            r1 = r13
        L_0x0031:
            com.google.android.gms.measurement.internal.b3 r2 = r14.mo19287w()     // Catch:{ all -> 0x00f5 }
            java.lang.String r3 = "Error querying for table"
            r2.mo38858c(r3, r10, r0)     // Catch:{ all -> 0x00f5 }
        ...
        L_0x00cf:
            ...
            com.google.android.gms.measurement.internal.b3 r1 = r14.mo19287w()     // Catch:{ SQLiteException -> 0x00ea }
            ...
            r1.mo38858c(r2, r10, r0)     // Catch:{ SQLiteException -> 0x00ea }
        L_0x00e4:
            return
        L_0x00e5:
            r0 = move-exception
        ...
        L_0x00ea:
            r0 = move-exception
            com.google.android.gms.measurement.internal.b3 r1 = r14.mo19282q()
        ...
        L_0x0106:
            goto L_0x0105
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C9804j.m45181a(com.google.android.gms.measurement.internal.d3, android.database.sqlite.SQLiteDatabase, java.lang.String, java.lang.String, java.lang.String, java.lang.String[]):void");
    }

    /* renamed from: b */
    static void m45182b(C4667d3 d3Var, SQLiteDatabase sQLiteDatabase) {
        if (d3Var != null) {
            File file = new File(sQLiteDatabase.getPath());
            if (!file.setReadable(false, false)) {
                d3Var.mo19287w().mo38856a("Failed to turn off database read permission");
            }
            if (!file.setWritable(false, false)) {
                d3Var.mo19287w().mo38856a("Failed to turn off database write permission");
            }
            if (!file.setReadable(true, true)) {
                d3Var.mo19287w().mo38856a("Failed to turn on database read permission for owner");
            }
            if (!file.setWritable(true, true)) {
                d3Var.mo19287w().mo38856a("Failed to turn on database write permission for owner");
                return;
            }
            return;
        }
