...
public enum dp3 {
    ...
    /* renamed from: o0 */
    private static final dp3[] f30932o0 = null;

    /* renamed from: b */
    private final yp3 f30945b;

    /* renamed from: c */
    private final int f30946c;

    /* renamed from: d */
    private final Class<?> f30947d;

    static {
        int i;
        f30932o0 = new dp3[r1];
        for (dp3 dp3 : values()) {
            f30932o0[dp3.f30946c] = dp3;
        }
    }

    private dp3(int i, int i2, yp3 yp3) {
        this.f30946c = i;
        this.f30945b = yp3;
        yp3 yp32 = yp3.VOID;
        int i3 = i2 - 1;
        if (i3 == 1) {
            this.f30947d = yp3.mo35954d();
        } else if (i3 != 3) {
            this.f30947d = null;
        } else {
            this.f30947d = yp3.mo35954d();
