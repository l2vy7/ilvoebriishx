...
/* renamed from: com.google.android.gms.internal.clearcut.e4 */
abstract class C8888e4 {
    C8888e4() {
    }

    /* renamed from: d */
    static void m41743d(CharSequence charSequence, ByteBuffer byteBuffer) {
        int i;
    ...
    /* renamed from: a */
    public abstract int mo36885a(int i, byte[] bArr, int i2, int i3);

    /* access modifiers changed from: package-private */
    /* renamed from: b */
    public abstract int mo36886b(CharSequence charSequence, byte[] bArr, int i, int i2);

    /* access modifiers changed from: package-private */
    /* renamed from: c */
    public abstract void mo36887c(CharSequence charSequence, ByteBuffer byteBuffer);

    /* access modifiers changed from: package-private */
    /* renamed from: e */
    public final boolean mo36888e(byte[] bArr, int i, int i2) {
        return mo36885a(0, bArr, i, i2) == 0;
    }
}
