...
public class ShapeableImageView extends AppCompatImageView implements C10913p {
    ...
    public ShapeableImageView(android.content.Context r7, android.util.AttributeSet r8, int r9) {
        /*
            r6 = this;
            int r0 = f47940v
            android.content.Context r7 = p245q6.C10962a.m49296c(r7, r8, r9, r0)
            r6.<init>(r7, r8, r9)
            p6.n r7 = p242p6.C10901n.m49062k()
            r6.f47941d = r7
            ...
            r2.<init>()
            r6.f47951n = r2
            int[] r2 = p193c6.C6532l.f27115u6
            android.content.res.TypedArray r2 = r1.obtainStyledAttributes(r8, r2, r9, r0)
            int r4 = p193c6.C6532l.f26638C6
            android.content.res.ColorStateList r4 = p232m6.C10805c.m48753a(r1, r2, r4)
            r6.f47947j = r4
            int r4 = p193c6.C6532l.f26649D6
            int r4 = r2.getDimensionPixelSize(r4, r7)
            float r4 = (float) r4
            r6.f47950m = r4
            int r4 = p193c6.C6532l.f27126v6
            int r7 = r2.getDimensionPixelSize(r4, r7)
            r6.f47952o = r7
            r6.f47953p = r7
            r6.f47954q = r7
            r6.f47955r = r7
            int r4 = p193c6.C6532l.f27159y6
            int r4 = r2.getDimensionPixelSize(r4, r7)
            r6.f47952o = r4
            int r4 = p193c6.C6532l.f26627B6
            int r4 = r2.getDimensionPixelSize(r4, r7)
            r6.f47953p = r4
            int r4 = p193c6.C6532l.f27170z6
            int r4 = r2.getDimensionPixelSize(r4, r7)
            r6.f47954q = r4
            int r4 = p193c6.C6532l.f27137w6
            int r7 = r2.getDimensionPixelSize(r4, r7)
            r6.f47955r = r7
            int r7 = p193c6.C6532l.f26616A6
            r4 = -2147483648(0xffffffff80000000, float:-0.0)
            int r7 = r2.getDimensionPixelSize(r7, r4)
            r6.f47956s = r7
            int r7 = p193c6.C6532l.f27148x6
            int r7 = r2.getDimensionPixelSize(r7, r4)
            r6.f47957t = r7
            r2.recycle()
            ...
            r7.setStyle(r2)
            r7.setAntiAlias(r3)
            p6.m$b r7 = p242p6.C10897m.m48996e(r1, r8, r9, r0)
            p6.m r7 = r7.mo43154m()
            r6.f47949l = r7
