...
public class C4317rm implements C4307rc {
    ...
    public final boolean mo16599f(byte[] bArr, int i, int i2, boolean z) throws IOException {
        return this.f18524a.mo16599f(bArr, 0, i2, z);
    }

    /* renamed from: g */
    public final void mo16600g(byte[] bArr, int i, int i2) throws IOException {
        this.f18524a.mo16600g(bArr, i, i2);
    }

    /* renamed from: i */
    public final void mo16602i(int i) throws IOException {
        this.f18524a.mo16602i(i);
    }

    /* renamed from: j */
    public final void mo16603j() {
        this.f18524a.mo16603j();
    }

    /* renamed from: k */
    public long mo16604k() {
        return this.f18524a.mo16604k();
    }

    /* renamed from: l */
    public long mo16605l() {
        return this.f18524a.mo16605l();
    }

    /* renamed from: m */
    public long mo16606m() {
        return this.f18524a.mo16606m();
    }
