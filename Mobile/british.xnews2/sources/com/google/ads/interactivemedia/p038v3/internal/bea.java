...
/* renamed from: com.google.ads.interactivemedia.v3.internal.bea */
...
public final class bea {
    ...
    /* renamed from: a */
    public static void m15756a(int i) throws InvalidAlgorithmParameterException {
        if (i != 16 && i != 32) {
    ...
    /* renamed from: b */
    public static void m15757b(int i) throws GeneralSecurityException {
        if (i < 0 || i > 0) {
