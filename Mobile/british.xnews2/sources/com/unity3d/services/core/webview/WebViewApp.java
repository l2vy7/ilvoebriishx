...
public class WebViewApp implements IWebViewBridgeInvoker {
    ...
    public static boolean create(final Configuration configuration) throws IllegalThreadStateException {
        ...
        if (!Thread.currentThread().equals(Looper.getMainLooper().getThread())) {
                        ...
                        if (urlWithQueryString == null) {
                            ...
                            try {
                                if (configuration.getWebViewUrl() != null) {
                                    str = str + "&origin=" + URLEncoder.encode(configuration.getWebViewUrl(), C6540C.UTF8_NAME);
                                }
                            ...
                            try {
                                if (configuration.getWebViewVersion() != null) {
                                    str = str + "&version=" + URLEncoder.encode(configuration.getWebViewVersion(), C6540C.UTF8_NAME);
                                }
                            } catch (UnsupportedEncodingException e2) {
                                DeviceLog.exception("Unsupported charset when encoding webview version", e2);
                            }
                            webViewApp.getWebView().loadDataWithBaseURL("file://" + SdkProperties.getLocalWebViewFile() + str, configuration.getWebViewData(), "text/html", C6540C.UTF8_NAME, (String) null);
                        } else {
                            webViewApp.getWebView().loadDataWithBaseURL(urlWithQueryString, configuration.getWebViewData(), "text/html", C6540C.UTF8_NAME, (String) null);
                        }
            ...
            if (!z) {
                SDKMetrics.getInstance().sendEvent("native_webview_creation_failed", new HashMap<String, String>(block, z2, z3) {
