...
/* compiled from: Sta */
public class C12221f {

    /* renamed from: com.startapp.sdk.ads.splash.f$a */
    /* compiled from: Sta */
    public static /* synthetic */ class C12222a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f54324a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f54324a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f54324a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f54324a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f54324a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.startapp.sdk.ads.splash.C12221f.C12222a.<clinit>():void");
        }
    }

    /* renamed from: a */
    public static View m52971a(Context context, SplashConfig splashConfig) {
        int i;
        int i2;
        int i3;
        int i4;
        ...
        Point point = new Point(C11975j0.m52484a(context2, 1, (float) IronSourceConstants.REWARDED_VIDEO_DAILY_CAPPED), C11975j0.m52484a(context2, 1, (float) 28));
        if (splashConfig.getOrientation() == SplashConfig.Orientation.PORTRAIT) {
            i4 = C11975j0.m52484a(context2, 1, (float) 5);
            i3 = C11975j0.m52484a(context2, 1, (float) 8);
            i2 = C11975j0.m52484a(context2, 1, (float) 75);
            i = C11975j0.m52484a(context2, 1, (float) TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
        } else {
            i4 = C11975j0.m52484a(context2, 1, (float) 5);
            i3 = C11975j0.m52484a(context2, 1, (float) 8);
            i2 = C11975j0.m52484a(context2, 1, (float) 40);
            i = C11975j0.m52484a(context2, 1, (float) 100);
        }
