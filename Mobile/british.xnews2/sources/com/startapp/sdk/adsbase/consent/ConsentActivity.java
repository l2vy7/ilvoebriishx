...
public class ConsentActivity extends Activity {
    ...
    public void onBackPressed() {
        ...
        if (str != null && url != null && url.contains(str)) {
            this.f54562a.loadUrl("javascript:startappBackPressed();");
        } else if (this.f54562a.canGoBack()) {
            this.f54562a.goBack();
        } else {
            this.f54564c = true;
            super.onBackPressed();
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!TextUtils.isEmpty(dataString)) {
            try {
                ...
                this.f54563b = new URI(uri.getScheme(), uri.getAuthority(), uri.getPath(), (String) null, (String) null).toString();
                WebView b = ComponentLocator.m23305a((Context) this).mo21236w().mo45309b();
                this.f54562a = b;
                b.setWebViewClient(new C12278a());
                this.f54562a.getSettings().setJavaScriptEnabled(true);
                this.f54562a.setHorizontalScrollBarEnabled(false);
                this.f54562a.setVerticalScrollBarEnabled(false);
                if (Build.VERSION.SDK_INT >= 15) {
                    this.f54562a.getSettings().setTextZoom(100);
                } else {
                    this.f54562a.getSettings().setTextSize(WebSettings.TextSize.NORMAL);
                }
                this.f54562a.loadUrl(dataString);
                this.f54562a.setBackgroundColor(0);
                C12437y.m53779a(this.f54562a, (Paint) null);
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.addRule(13);
                relativeLayout.addView(this.f54562a, layoutParams2);
            } catch (Throwable th) {
                C5004d4.m22887a(th);
            }
        }
    ...
    public void onStop() {
        ...
        if (!this.f54564c && l != null && l.mo46204j() && C5015nb.m22938g(this) && C5015nb.m22936e((Context) this)) {
            C5004d4 d4Var = new C5004d4(C11882e4.f52885d);
            d4Var.f22126d = "ConsentActivityHasBeenCovered";
            d4Var.mo20661a();
            finish();
            try {
        ...
        C5001b2 f = ComponentLocator.m23305a((Context) this).mo21219f();
        f.f22114d = false;
        Intent intent = f.f22113c;
        if (intent != null) {
            try {
                f.f22111a.startActivity(intent);
            } catch (Throwable th2) {
                C5004d4.m22887a(th2);
            }
        }
    ...
    /* compiled from: Sta */
    public class C12278a extends WebViewClient {
        public C12278a() {
        }
        ...
        public final boolean mo46189a(android.net.Uri r12) {
            /*
                r11 = this;
                ...
                com.startapp.sdk.adsbase.consent.ConsentConfig r2 = r2.mo21200l()
                r3 = 0
            ...
            L_0x0060:
                ...
                com.startapp.sdk.components.ComponentLocator r12 = com.startapp.sdk.components.ComponentLocator.m23305a((android.content.Context) r12)
                com.startapp.b2 r5 = r12.mo21219f()
                long r0 = r2.mo46203i()
                java.lang.Long r7 = java.lang.Long.valueOf(r0)
                r9 = 1
                r10 = 1
                r5.mo20652a(r6, r7, r8, r9, r10)
                return r4
            L_0x0079:
            ...
            L_0x008c:
                return r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.startapp.sdk.adsbase.consent.ConsentActivity.C12278a.mo46189a(android.net.Uri):boolean");
        }
        ...
        public void onPageFinished(android.webkit.WebView r8, java.lang.String r9) {
            ...
            L_0x0040:
                ...
                java.util.Map<android.app.Activity, java.lang.Integer> r2 = com.startapp.C5015nb.f22145a
            ...
            L_0x005c:
                ...
                java.lang.String r9 = com.startapp.C5015nb.m22906a((android.graphics.drawable.Drawable) r2, (int) r5, (int) r5, (android.graphics.Bitmap.Config) r6)     // Catch:{ OutOfMemoryError -> 0x0072 }
                goto L_0x0083
            L_0x0072:
                ...
                java.lang.String r9 = com.startapp.C5015nb.m22906a((android.graphics.drawable.Drawable) r2, (int) r9, (int) r9, (android.graphics.Bitmap.Config) r5)     // Catch:{ OutOfMemoryError -> 0x0082 }
                goto L_0x0083
            L_0x007e:
                r9 = move-exception
            ...
            L_0x00eb:
                com.startapp.sdk.adsbase.consent.ConsentActivity r9 = com.startapp.sdk.adsbase.consent.ConsentActivity.this
                com.startapp.sdk.components.ComponentLocator r9 = com.startapp.sdk.components.ComponentLocator.m23305a((android.content.Context) r9)
                com.startapp.w5 r9 = r9.mo21227n()
                java.lang.Object r9 = r9.mo45342b()
                com.startapp.v5 r9 = (com.startapp.C12387v5) r9
                java.lang.String r9 = r9.f54888c
                boolean r2 = android.text.TextUtils.isEmpty(r9)
            ...
            L_0x01d8:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.startapp.sdk.adsbase.consent.ConsentActivity.C12278a.onPageFinished(android.webkit.WebView, java.lang.String):void");
        }

        @TargetApi(24)
        public boolean shouldOverrideUrlLoading(WebView webView, WebResourceRequest webResourceRequest) {
            return mo46189a(webResourceRequest.getUrl());
        }

        public boolean shouldOverrideUrlLoading(WebView webView, String str) {
            return mo46189a(Uri.parse(str));
        }
    }
}
