...
public class s_cargar_fondo extends IntentService {
    ...
    public void onHandleIntent(android.content.Intent r6) {
        /*
            ...
            r6.append(r0)
            british.xnews2.config r0 = r5.f8472b
            int r0 = r0.f7163D
            r6.append(r0)
        ...
        L_0x008e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: british.xnews2.s_cargar_fondo.onHandleIntent(android.content.Intent):void");
    }
}
