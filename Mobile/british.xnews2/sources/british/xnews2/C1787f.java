...
public class C1787f implements Thread.UncaughtExceptionHandler {
    ...
    /* renamed from: british.xnews2.f$a */
    /* compiled from: CustomExceptionHandler */
    private class C1788a extends AsyncTask<String, Void, Byte> {
        ...
        public Byte doInBackground(String... strArr) {
            try {
                ...
                C12831e eVar = new C12831e(C1692config.f7107G5 + "log.e-droid.net/srv/log.php?v=" + 144 + "&vcode=" + 1 + "&idapp=" + 2260177 + "&nivelapi=" + Build.VERSION.SDK_INT + "&dispo=" + URLEncoder.encode(this.f7705b, C6540C.UTF8_NAME));
