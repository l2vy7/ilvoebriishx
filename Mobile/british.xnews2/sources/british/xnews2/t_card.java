...
public class t_card extends Activity_ext_class implements C1592a, View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener, RewardedVideoAdListener, OnAdLoaded, OnAdClosed, OnVideoEnded, OnAdError, VideoListener, AdEventListener, AdColonyRewardListener {
    ...
    /* renamed from: british.xnews2.t_card$a */
    ...
    /* renamed from: british.xnews2.t_card$b */
    ...
    /* renamed from: british.xnews2.t_card$c */
    ...
    /* renamed from: british.xnews2.t_card$d */
    ...
    /* renamed from: british.xnews2.t_card$e */
    class C2207e extends RewardedAdLoadCallback {

        /* renamed from: a */
        final /* synthetic */ Context f9073a;

        /* renamed from: british.xnews2.t_card$e$a */
        ...
        /* renamed from: british.xnews2.t_card$e$b */
    ...
    /* renamed from: british.xnews2.t_card$f */
    ...
    /* renamed from: british.xnews2.t_card$g */
    ...
    /* renamed from: british.xnews2.t_card$h */
    ...
    /* renamed from: british.xnews2.t_card$i */
    ...
    /* renamed from: british.xnews2.t_card$j */
    ...
    /* renamed from: british.xnews2.t_card$k */
    ...
    /* renamed from: british.xnews2.t_card$l */
    ...
    /* renamed from: british.xnews2.t_card$m */
    ...
    /* renamed from: british.xnews2.t_card$n */
    ...
    /* renamed from: british.xnews2.t_card$o */
    ...
    /* renamed from: british.xnews2.t_card$p */
    ...
    /* renamed from: british.xnews2.t_card$q */
    ...
    /* renamed from: british.xnews2.t_card$r */
    ...
    /* renamed from: british.xnews2.t_card$s */
    private class C2223s extends AsyncTask<String, Void, String> {
        ...
        public java.lang.String doInBackground(java.lang.String... r6) {
            /*
                ...
                r0.append(r1)     // Catch:{ Exception -> 0x008e }
                british.xnews2.t_card r1 = british.xnews2.t_card.this     // Catch:{ Exception -> 0x008e }
            ...
            L_0x009d:
                goto L_0x009c
            */
            throw new UnsupportedOperationException("Method not decompiled: british.xnews2.t_card.C2223s.doInBackground(java.lang.String[]):java.lang.String");
        }
    ...
    /* renamed from: british.xnews2.t_card$t */
    private class C2224t extends AsyncTask<String, Void, String> {
        ...
        public java.lang.String doInBackground(java.lang.String... r5) {
            ...
            L_0x000a:
                ...
                british.xnews2.t_card r1 = british.xnews2.t_card.this     // Catch:{ MalformedURLException -> 0x008b }
            ...
            L_0x008b:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: british.xnews2.t_card.C2224t.doInBackground(java.lang.String[]):java.lang.String");
        }
            ...
            if (this.f9109e != -1) {
                ...
                if (t_card.f9043E != null) {
                    ...
                    if (str.equals(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE)) {
                        SharedPreferences.Editor edit = t_card.this.f9054P.edit();
                        edit.putInt("c2260177_" + t_card.this.f9043E.get(this.f9109e).f9090a + "_" + this.f9107c + "_v", Integer.parseInt(this.f9106b));
                        edit.commit();
                        Bitmap bitmap = null;
                        try {
            ...
            if (t_card.f9043E != null && t_card.f9059q.f7313c1 != null) {
                ...
                while (i < t_card.this.f9043E.size()) {
                    ...
                    if (qVar.f9091b) {
                        ...
                        this.f9110f = 1;
                        this.f9107c = "main";
                        this.f9105a = "c2260177_" + qVar.f9090a + "_main.png";
                        ...
                        this.f9110f = 2;
                        this.f9107c = "logo";
                        this.f9105a = "c2260177_" + qVar.f9090a + "_logo.png";
                        ...
                        this.f9110f = 3;
                        this.f9107c = "btn";
                        this.f9105a = "c2260177_" + qVar.f9090a + "_btn.png";
    ...
    /* renamed from: british.xnews2.t_card$u */
    private class C2225u extends AsyncTask<String, Void, String> {
        ...
        public java.lang.String doInBackground(java.lang.String... r5) {
            ...
            L_0x008b:
                return r5
            */
            throw new UnsupportedOperationException("Method not decompiled: british.xnews2.t_card.C2225u.doInBackground(java.lang.String[]):java.lang.String");
        }
        ...
        public void onPostExecute(String str) {
            if (this.f9115d != -1) {
                ...
                if (t_card.f9044F != null) {
                    ...
                    if (str.equals(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE)) {
                        SharedPreferences.Editor edit = t_card.this.f9054P.edit();
                        edit.putInt("o2260177_" + t_card.this.f9044F.get(this.f9115d).f9098a + "_v", Integer.parseInt(this.f9113b));
                        edit.commit();
                        boolean z = true;
                        Bitmap bitmap = null;
                        try {
        ...
        public void onPreExecute() {
            if (t_card.this.f9044F != null) {
                for (int i = 0; i < t_card.this.f9044F.size(); i++) {
                    ...
                    if (rVar.f9100c) {
                        this.f9115d = i;
                        this.f9112a = "o2260177_" + rVar.f9098a + ".png";
    ...
    private CardView m8685b(String str, int i, boolean z) {
        ...
        if (split[3].equals(IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE)) {
            ...
            if (parseInt > sharedPreferences.getInt(sb.toString(), -1)) {
                ...
                File file = new File(filesDir, "o2260177_" + rVar.f9098a + ".png");
                if (file.exists()) {
                    try {
                ...
                if (str20.equals(str21)) {
                    ...
                    while (i15 < i14) {
                        ...
                        if (!equals || !split2[43].equals(str26)) {
                            ...
                            if (str28.equals(sb.toString())) {
                                ...
                                if (split2[16].equals(str26)) {
                                    ...
                                    if (parseInt2 > sharedPreferences.getInt(sb3.toString(), -1)) {
                                        ...
                                        File file = new File(getApplicationContext().getFilesDir(), "c2260177_" + qVar3.f9090a + "_logo.png");
                                        if (file.exists()) {
                                            try {
                                ...
                                if (split2[24].equals(str26)) {
                                    if (Integer.parseInt(split2[25]) > t_card3.f9054P.getInt("c2260177_" + qVar3.f9090a + "_btn_v", -1)) {
                                        qVar3.f9093d = true;
                                        ...
                                        File file2 = new File(getApplicationContext().getFilesDir(), "c2260177_" + qVar3.f9090a + "_btn.png");
                                        if (file2.exists()) {
                                            try {
                            ...
                            if (Integer.parseInt(split2[9]) > t_card3.f9054P.getInt("c2260177_" + qVar3.f9090a + "_main_v", -1)) {
                                qVar3.f9091b = true;
                                ...
                                File file3 = new File(getApplicationContext().getFilesDir(), "c2260177_" + qVar3.f9090a + "_main.png");
                                if (file3.exists()) {
                                    try {
