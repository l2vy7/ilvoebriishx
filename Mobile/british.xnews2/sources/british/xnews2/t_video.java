...
public class t_video extends FragmentActivity_ext_class implements C1592a, View.OnKeyListener, View.OnClickListener, SharedPreferences.OnSharedPreferenceChangeListener, RewardedVideoAdListener, OnAdLoaded, OnAdClosed, OnVideoEnded, OnAdError, VideoListener, AdEventListener, AdColonyRewardListener {
    ...
    /* renamed from: B0 */
    HashMap<String, Bitmap> f9985B0;

    /* renamed from: C */
    Bundle f9986C;

    /* renamed from: C0 */
    HashMap<String, String> f9987C0;

    /* renamed from: D */
    C1603c f9988D;

    /* renamed from: D0 */
    HashMap<String, String> f9989D0;

    /* renamed from: E */
    boolean f9990E = false;
    ...
    /* renamed from: L0 */
    List<String> f10005L0 = new ArrayList();

    /* renamed from: M */
    boolean f10006M;

    /* renamed from: M0 */
    SharedPreferences f10007M0;

    /* renamed from: N */
    boolean f10008N;

    /* renamed from: N0 */
    FullscreenVideoLayout f10009N0;
    ...
    /* renamed from: R0 */
    public C10777q f10017R0;

    /* renamed from: S */
    private int f10018S;

    /* renamed from: S0 */
    private final C10779r f10019S0 = new C2502o();
    /* access modifiers changed from: private */
    ...
    /* renamed from: m0 */
    public String f10028m0;
    /* access modifiers changed from: private */

    /* renamed from: n0 */
    public String f10029n0;
    /* access modifiers changed from: private */

    /* renamed from: o0 */
    public String f10030o0;

    /* renamed from: p0 */
    boolean f10031p0 = false;
    ...
    /* renamed from: x0 */
    LinearLayout f10039x0;

    /* renamed from: y0 */
    ProgressBar f10040y0;

    /* renamed from: z0 */
    String f10041z0;

    /* renamed from: british.xnews2.t_video$a */
    class C2484a implements MediaPlayer.OnErrorListener {
        C2484a() {
        }
    ...
    /* renamed from: british.xnews2.t_video$b */
    class C2485b implements View.OnClickListener {
        C2485b() {
        }
    ...
    /* renamed from: british.xnews2.t_video$c */
    class C2486c implements View.OnClickListener {
        C2486c() {
        }
    ...
    /* renamed from: british.xnews2.t_video$d */
    class C2487d extends RewardedAdLoadCallback {

        /* renamed from: a */
        final /* synthetic */ Context f10045a;

        /* renamed from: british.xnews2.t_video$d$a */
        class C2488a extends FullScreenContentCallback {
            C2488a() {
            }

            public void onAdDismissedFullScreenContent() {
                t_video t_video = t_video.this;
                if (t_video.f9990E) {
                    t_video.abrir_secc(t_video.f6672u);
                }
            }
        ...
        /* renamed from: british.xnews2.t_video$d$b */
        class C2489b implements OnUserEarnedRewardListener {
            C2489b() {
            }

            public void onUserEarnedReward(RewardItem rewardItem) {
                C2487d dVar = C2487d.this;
                t_video.this.f9990E = true;
                C1692config.m8175Y0(dVar.f10045a);
            }
        }

        C2487d(Context context) {
            this.f10045a = context;
        }

        /* renamed from: a */
        public void onAdLoaded(RewardedAd rewardedAd) {
            t_video.this.f6673v.cancel();
            rewardedAd.setFullScreenContentCallback(new C2488a());
            rewardedAd.show((Activity) this.f10045a, new C2489b());
        }

        public void onAdFailedToLoad(LoadAdError loadAdError) {
            t_video t_video = t_video.this;
            if (!t_video.f9984B.mo7502f(this.f10045a, t_video.f6675x)) {
                t_video.this.f6673v.cancel();
                t_video t_video2 = t_video.this;
                t_video2.abrir_secc(t_video2.f6672u);
            }
        }
    }

    /* renamed from: british.xnews2.t_video$e */
    class C2490e implements AdDisplayListener {
        C2490e() {
        }
    ...
    /* renamed from: british.xnews2.t_video$f */
    class C2491f extends AdColonyInterstitialListener {
        C2491f() {
        }
    ...
    /* renamed from: british.xnews2.t_video$g */
    class C2492g implements SearchManager.OnCancelListener {
        C2492g() {
        }

        public void onCancel() {
            t_video t_video = t_video.this;
            t_video.f6669r = false;
            t_video.setResult(0);
        }
    }

    /* renamed from: british.xnews2.t_video$h */
    class C2493h implements SearchManager.OnDismissListener {
        C2493h() {
        }

        public void onDismiss() {
            t_video.this.f6670s = false;
        }
    }

    /* renamed from: british.xnews2.t_video$i */
    class C2494i implements View.OnClickListener {
        C2494i() {
        }
    ...
    /* renamed from: british.xnews2.t_video$j */
    class C2495j implements View.OnClickListener {
        C2495j() {
        }
    ...
    /* renamed from: british.xnews2.t_video$k */
    class C2496k implements View.OnClickListener {
        C2496k() {
        }
    ...
    /* renamed from: british.xnews2.t_video$l */
    class C2497l implements View.OnClickListener {
        C2497l() {
        }
        ...
        public void onClick(View view) {
            ...
            t_video t_video = t_video.this;
            if (!t_video.f10012P) {
                Intent intent = new Intent(t_video.this, chat_perfil.class);
                t_video t_video2 = t_video.this;
                intent.putExtra("idsecc", t_video2.f9984B.f7231O1[t_video2.f10011O0].f7964y);
                intent.putExtra("desde_video", true);
                boolean z = t_video.this.f6671t;
                if (z) {
                    intent.putExtra("es_root", z);
                }
                t_video t_video3 = t_video.this;
                t_video3.f6671t = false;
                t_video3.f6669r = true;
                t_video3.startActivityForResult(intent, 0);
            } else if (t_video.findViewById(R.id.sv_chat).getVisibility() == 0) {
                t_video.this.m8971S();
            } else {
                t_video.this.f10009N0.mo7134p();
                t_video.this.findViewById(R.id.sv_chat).setVisibility(0);
                t_video t_video4 = t_video.this;
                if (!t_video4.f9984B.f7279W1 && (cVar = t_video4.f9988D) != null && cVar.f6886a != null) {
                    t_video4.m8975Y();
                }
            }
        }
    ...
    /* renamed from: british.xnews2.t_video$m */
    class C2498m implements Runnable {

        /* renamed from: b */
        final /* synthetic */ SharedPreferences f10057b;

        /* renamed from: british.xnews2.t_video$m$a */
        class C2499a implements View.OnClickListener {
            C2499a() {
            }

            public void onClick(View view) {
                t_video t_video = t_video.this;
                t_video.f9984B.mo7489T(t_video, (ImageView) view, t_video.f6668q);
            }
        }

        /* renamed from: british.xnews2.t_video$m$b */
        class C2500b implements Runnable {
            C2500b() {
            }

            public void run() {
                ((ScrollView) t_video.this.findViewById(R.id.sv_chat)).fullScroll(TsExtractor.TS_STREAM_TYPE_HDMV_DTS);
            }
        }

        C2498m(SharedPreferences sharedPreferences) {
            this.f10057b = sharedPreferences;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:255:0x07ed, code lost:
            r5 = british.xnews2.R.drawable.bubble4_flip;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:266:0x0811, code lost:
            r5 = british.xnews2.R.drawable.bubble4;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:3:0x0032, code lost:
            if (r2.equals(british.xnews2.t_video.m8959G(r1.f10058c) + "") == false) goto L_0x0034;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:7:0x004e, code lost:
            if (r1.f10057b.getString("f2_id", "").equals(r1.f10057b.getString("f2_idusu_prev", "")) != false) goto L_0x0050;
         */
        ...
        public void run() {
            /*
                ...
                android.content.SharedPreferences r2 = r1.f10057b
                ...
                r7.<init>()
                british.xnews2.t_video r8 = british.xnews2.t_video.this
                java.lang.String r8 = r8.f10028m0
                r7.append(r8)
                r7.append(r6)
            ...
            L_0x0034:
                ...
                android.content.SharedPreferences r2 = r1.f10057b
                java.lang.String r2 = r2.getString(r5, r6)
                android.content.SharedPreferences r7 = r1.f10057b
            ...
            L_0x0052:
                ...
                british.xnews2.t_video r2 = british.xnews2.t_video.this
                android.content.SharedPreferences r7 = r1.f10057b
            ...
            L_0x00a7:
                r2 = 0
            L_0x00a8:
                android.content.SharedPreferences r8 = r1.f10057b
                ...
                british.xnews2.t_video r10 = british.xnews2.t_video.this
                java.lang.String r10 = r10.f10029n0
            ...
            L_0x00d9:
                ...
                r11 = -2
                r10.<init>(r13, r11)
                british.xnews2.t_video r11 = british.xnews2.t_video.this
                int r11 = r11.f10036u0
            ...
            L_0x013f:
                british.xnews2.t_video r10 = british.xnews2.t_video.this
                int r11 = r10.f10037v0
                int r10 = r10.f10038w0
                r8.setPadding(r11, r10, r11, r4)
                british.xnews2.t_video r10 = british.xnews2.t_video.this
                british.xnews2.config r10 = r10.f9984B
                boolean r10 = r10.f7332f2
                if (r10 == 0) goto L_0x01b0
                android.content.SharedPreferences r10 = r1.f10057b
                java.lang.String r10 = r10.getString(r5, r6)
                java.lang.StringBuilder r11 = new java.lang.StringBuilder
                r11.<init>()
                british.xnews2.t_video r13 = british.xnews2.t_video.this
                long r12 = r13.f10014Q
                r11.append(r12)
                r11.append(r6)
            ...
            L_0x018d:
                ...
                android.content.SharedPreferences r13 = r1.f10057b
                java.lang.String r13 = r13.getString(r5, r6)
                r10.setTag(r12, r13)
                android.view.View r10 = r8.findViewById(r11)
                british.xnews2.t_video$m$a r11 = new british.xnews2.t_video$m$a
                r11.<init>()
                r10.setOnClickListener(r11)
            L_0x01b0:
                british.xnews2.t_video r10 = british.xnews2.t_video.this
                int r10 = r10.f10034s0
                if (r10 == 0) goto L_0x01c7
                boolean r10 = r0.booleanValue()
                if (r10 != 0) goto L_0x01c7
                android.view.View r10 = r8.findViewById(r15)
                british.xnews2.t_video r11 = british.xnews2.t_video.this
                int r11 = r11.f10034s0
            ...
            L_0x0231:
                ...
                british.xnews2.t_video r12 = british.xnews2.t_video.this
                java.lang.String r12 = r12.f10041z0
                java.lang.String r15 = "FFFFFFFF"
                boolean r12 = r12.equals(r15)
                if (r12 == 0) goto L_0x0290
                british.xnews2.t_video r12 = british.xnews2.t_video.this
                java.lang.String r12 = r12.f9983A0
                java.lang.String r15 = "FFFFFFFF"
                boolean r12 = r12.equals(r15)
                if (r12 == 0) goto L_0x0290
                java.lang.StringBuilder r7 = new java.lang.StringBuilder
            ...
            L_0x0290:
                ...
                british.xnews2.t_video r15 = british.xnews2.t_video.this
                boolean r15 = r15.f10008N
            ...
            L_0x02a2:
                ...
                android.content.SharedPreferences r12 = r1.f10057b
                java.lang.String r12 = r12.getString(r5, r6)
                java.lang.StringBuilder r15 = new java.lang.StringBuilder
                r15.<init>()
                british.xnews2.t_video r14 = british.xnews2.t_video.this
                r16 = r13
                long r13 = r14.f10014Q
                r15.append(r13)
                r15.append(r6)
            ...
            L_0x02d7:
                ...
                british.xnews2.t_video r11 = british.xnews2.t_video.this
                android.graphics.Bitmap r11 = r11.f9991E0
                if (r11 == 0) goto L_0x02f6
            ...
            L_0x02fc:
                ...
                r8.setTag(r11, r12)
                british.xnews2.t_video r11 = british.xnews2.t_video.this
                british.xnews2.config r11 = r11.f9984B
                boolean r11 = r11.f7397p2
                if (r11 == 0) goto L_0x03b5
                android.content.SharedPreferences r11 = r1.f10057b
            ...
            L_0x0536:
                british.xnews2.t_video r14 = british.xnews2.t_video.this
                r17 = r7
                british.xnews2.config r7 = r14.f9984B
                boolean r7 = r7.f7297Z1
                if (r7 != 0) goto L_0x0549
                boolean r7 = r14.f10008N
            ...
            L_0x0549:
                ...
                android.content.SharedPreferences r14 = r1.f10057b
                java.lang.String r14 = r14.getString(r5, r6)
                boolean r14 = r14.equals(r15)
                if (r14 == 0) goto L_0x0577
                british.xnews2.t_video r7 = british.xnews2.t_video.this
            ...
            L_0x05ae:
                ...
                british.xnews2.t_video r13 = british.xnews2.t_video.this
                java.util.HashMap<java.lang.String, android.graphics.Bitmap> r13 = r13.f9985B0
            ...
            L_0x05d3:
                ...
                british.xnews2.t_video r14 = british.xnews2.t_video.this     // Catch:{ Exception -> 0x067a }
                java.io.File r14 = r14.f9997H0     // Catch:{ Exception -> 0x067a }
                r18 = r12
                ...
                british.xnews2.t_video r14 = british.xnews2.t_video.this     // Catch:{ Exception -> 0x0677 }
            ...
            L_0x063d:
                ...
                int r3 = british.xnews2.C1692config.m8193n(r5, r3, r12, r14)     // Catch:{ Exception -> 0x0673 }
                ...
                goto L_0x0668
            L_0x065a:
                british.xnews2.t_video r3 = british.xnews2.t_video.this     // Catch:{ Exception -> 0x0673 }
            ...
            L_0x0668:
                ...
                british.xnews2.t_video r5 = british.xnews2.t_video.this     // Catch:{ Exception -> 0x0673 }
                java.util.HashMap<java.lang.String, android.graphics.Bitmap> r5 = r5.f9985B0     // Catch:{ Exception -> 0x0673 }
            ...
            L_0x067a:
                ...
                r18 = r12
            L_0x0680:
                british.xnews2.t_video r3 = british.xnews2.t_video.this
                boolean r5 = r3.f10008N
            ...
            L_0x06a7:
                android.content.SharedPreferences r3 = r1.f10057b
            ...
            L_0x06e1:
                british.xnews2.t_video r3 = british.xnews2.t_video.this
                java.util.HashMap<java.lang.String, java.lang.String> r3 = r3.f9987C0
                boolean r3 = r3.containsKey(r11)
                if (r3 != 0) goto L_0x0737
                british.xnews2.t_video r3 = british.xnews2.t_video.this
                java.util.HashMap<java.lang.String, java.lang.String> r3 = r3.f9989D0
                boolean r3 = r3.containsKey(r11)
            ...
            L_0x0705:
                ...
                r3.put(r11, r7)
                british.xnews2.t_video r3 = british.xnews2.t_video.this
                british.xnews2.t_video$s r3 = r3.f9995G0
            ...
            L_0x071a:
                british.xnews2.t_video r3 = british.xnews2.t_video.this
                british.xnews2.t_video$s r5 = new british.xnews2.t_video$s
                british.xnews2.t_video r7 = british.xnews2.t_video.this
                r11 = 0
                r5.<init>()
                r3.f9995G0 = r5
            ...
            L_0x073b:
                british.xnews2.t_video r3 = british.xnews2.t_video.this
                british.xnews2.config r3 = r3.f9984B
                int r5 = r3.f7338g2
                r11 = 2
                ...
                r3.<init>()
                r3.append(r4)
                british.xnews2.t_video r4 = british.xnews2.t_video.this
                british.xnews2.config r4 = r4.f9984B
            ...
            L_0x078b:
                ...
                british.xnews2.t_video r0 = british.xnews2.t_video.this
                british.xnews2.config r0 = r0.f9984B
                int r0 = r0.f7338g2
            ...
            L_0x082d:
                android.content.SharedPreferences r0 = r1.f10057b
                ...
                british.xnews2.t_video r2 = british.xnews2.t_video.this     // Catch:{ Exception -> 0x085b }
            ...
            L_0x085f:
                ...
                british.xnews2.t_video r0 = british.xnews2.t_video.this
                british.xnews2.config r2 = r0.f9984B
                boolean r2 = r2.f7297Z1
                if (r2 == 0) goto L_0x0871
                r0 = r13
                goto L_0x0879
            L_0x0871:
                boolean r0 = r0.f10004L
            ...
            L_0x087d:
                ...
                british.xnews2.t_video r0 = british.xnews2.t_video.this
                british.xnews2.config r3 = r0.f9984B
                int r4 = r3.f7338g2
            ...
            L_0x090d:
                ...
                british.xnews2.t_video r0 = british.xnews2.t_video.this
                android.widget.LinearLayout r0 = r0.f10039x0
                r0.addView(r8, r3)
                goto L_0x0946
            L_0x092b:
                british.xnews2.t_video r0 = british.xnews2.t_video.this
            ...
            L_0x097e:
                ...
                british.xnews2.t_video r2 = british.xnews2.t_video.this
                android.widget.LinearLayout r2 = r2.f10039x0
                int r2 = r2.getMeasuredHeight()
                int r3 = r0.getScrollY()
                int r4 = r0.getHeight()
                int r3 = r3 + r4
                if (r2 > r3) goto L_0x09a4
                british.xnews2.t_video$m$b r2 = new british.xnews2.t_video$m$b
                r2.<init>()
                r0.post(r2)
            L_0x09a4:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: british.xnews2.t_video.C2498m.run():void");
        }
    }

    /* renamed from: british.xnews2.t_video$n */
    class C2501n implements MediaPlayer.OnPreparedListener {
        C2501n() {
        }
    ...
    /* renamed from: british.xnews2.t_video$o */
    private class C2502o implements C10779r {

        /* renamed from: british.xnews2.t_video$o$a */
        class C2503a implements C4580e.C4582b {

            /* renamed from: a */
            final /* synthetic */ C4580e f10063a;
            ...
            /* renamed from: g */
            public void mo9083g() {
                t_video.this.startActivity(new Intent(t_video.this, ExpandedControlsActivity.class));
                this.f10063a.mo17821F(this);
            }
        ...
        /* renamed from: n */
        public void mo9077n(C10775p pVar, String str) {
            String str2;
            t_video.this.invalidateOptionsMenu();
            String string = t_video.this.f9986C.getString("url");
            MediaMetadata mediaMetadata = new MediaMetadata(1);
            t_video t_video = t_video.this;
            mediaMetadata.mo29283J0("com.google.android.gms.cast.metadata.TITLE", t_video.f9984B.f7231O1[t_video.f10011O0].f7898a);
            t_video t_video2 = t_video.this;
            C1855l[] lVarArr = t_video2.f9984B.f7231O1;
            int i = t_video2.f10011O0;
            if (!lVarArr[i].f7871M0 && lVarArr[i].f7869L0 != null) {
                if (lVarArr[i].f7875O0 == 0) {
                    StringBuilder sb = new StringBuilder();
                    sb.append(C1692config.f7108H5);
                    sb.append("/srv/imgs/seccs/");
                    t_video t_video3 = t_video.this;
                    sb.append(t_video3.f9984B.f7231O1[t_video3.f10011O0].f7964y);
                    sb.append("_ico.png?v=");
                    t_video t_video4 = t_video.this;
                    sb.append(t_video4.f9984B.f7231O1[t_video4.f10011O0].f7877P0);
                    str2 = sb.toString();
                } else {
                    StringBuilder sb2 = new StringBuilder();
                    sb2.append(C1692config.f7108H5);
                    sb2.append("/android-app-creator/icos_secc/");
                    t_video t_video5 = t_video.this;
                    sb2.append(t_video5.f9984B.f7231O1[t_video5.f10011O0].f7875O0);
                    sb2.append(".png");
                    str2 = sb2.toString();
                }
                mediaMetadata.mo29276C0(new WebImage(Uri.parse(str2)));
            }
            MediaInfo a = new MediaInfo.C7080a(string).mo29242d(0).mo29240b("video/*").mo29241c(mediaMetadata).mo29239a();
            try {
                t_video t_video6 = t_video.this;
                t_video6.f10015Q0 = t_video6.f10017R0.mo42953d();
                C4580e q = t_video.this.f10015Q0.mo22550q();
                q.mo17837b(new C2503a(q));
                t_video.this.f10009N0.mo7121e();
                q.mo17858w(a, true);
    ...
    /* renamed from: british.xnews2.t_video$p */
    private class C2504p extends AsyncTask<String, Void, String> {

        /* renamed from: british.xnews2.t_video$p$a */
        class C2505a implements View.OnClickListener {
            C2505a() {
            }

            public void onClick(View view) {
                t_video.this.findViewById(R.id.ll_btns).setVisibility(8);
                t_video.this.f10009N0.mo7123h();
                t_video.this.m8972T();
            }
        }
        ...
        public java.lang.String doInBackground(java.lang.String... r6) {
            /*
                ...
                british.xnews2.t_video r1 = british.xnews2.t_video.this     // Catch:{ Exception -> 0x007c }
                british.xnews2.config r1 = r1.f9984B     // Catch:{ Exception -> 0x007c }
            ...
            L_0x008b:
                goto L_0x008a
            */
            throw new UnsupportedOperationException("Method not decompiled: british.xnews2.t_video.C2504p.doInBackground(java.lang.String[]):java.lang.String");
        }
        ...
        public void onPostExecute(java.lang.String r7) {
            /*
                ...
                british.xnews2.t_video r5 = british.xnews2.t_video.this
                british.xnews2.FullscreenVideoLayout r5 = r5.f10009N0
            ...
            L_0x005b:
                ...
                android.view.View r0 = r0.findViewById(r2)
                british.xnews2.t_video$p$a r2 = new british.xnews2.t_video$p$a
                r2.<init>()
                r0.setOnClickListener(r2)
                british.xnews2.t_video r0 = british.xnews2.t_video.this
                british.xnews2.FullscreenVideoLayout r0 = r0.f10009N0
                r0.f6688J = r1
                r0.mo7134p()
                british.xnews2.t_video r0 = british.xnews2.t_video.this     // Catch:{ IOException -> 0x0084 }
                british.xnews2.FullscreenVideoLayout r0 = r0.f10009N0     // Catch:{ IOException -> 0x0084 }
                r1 = 0
                r0.mo7177k(r7, r1)     // Catch:{ IOException -> 0x0084 }
                goto L_0x008e
            L_0x0084:
                r7 = move-exception
                r7.printStackTrace()
            ...
            L_0x008e:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: british.xnews2.t_video.C2504p.onPostExecute(java.lang.String):void");
        }
    }

    /* renamed from: british.xnews2.t_video$q */
    private class C2506q extends AsyncTask<String, Void, String> {
        ...
        /* renamed from: british.xnews2.t_video$q$a */
        class C2507a implements DialogInterface.OnClickListener {
            C2507a() {
            }
        ...
        /* renamed from: british.xnews2.t_video$q$b */
        class C2508b implements DialogInterface.OnShowListener {

            /* renamed from: a */
            final /* synthetic */ AlertDialog f10072a;

            C2508b(AlertDialog alertDialog) {
                this.f10072a = alertDialog;
            }

            public void onShow(DialogInterface dialogInterface) {
                Button button = this.f10072a.getButton(-1);
                button.setTextColor(Color.parseColor("#" + t_video.this.f6668q));
                Button button2 = this.f10072a.getButton(-2);
                button2.setTextColor(Color.parseColor("#" + t_video.this.f6668q));
            }
        }

        public C2506q(String str, String str2, int i) {
            this.f10067a = str;
            this.f10068b = str2;
            this.f10069c = i;
        }
        ...
        public java.lang.String doInBackground(java.lang.String... r6) {
            /*
                ...
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
                british.xnews2.t_video r1 = british.xnews2.t_video.this     // Catch:{ Exception -> 0x00af }
                long r1 = r1.f10014Q     // Catch:{ Exception -> 0x00af }
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
                java.lang.String r1 = "&c="
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
                british.xnews2.t_video r1 = british.xnews2.t_video.this     // Catch:{ Exception -> 0x00af }
                java.lang.String r1 = r1.f10030o0     // Catch:{ Exception -> 0x00af }
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
                java.lang.String r1 = "&idtema="
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
                british.xnews2.t_video r1 = british.xnews2.t_video.this     // Catch:{ Exception -> 0x00af }
                int r1 = r1.f10016R     // Catch:{ Exception -> 0x00af }
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
                java.lang.String r1 = "&idf="
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
                int r1 = r5.f10069c     // Catch:{ Exception -> 0x00af }
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
                java.lang.String r1 = "&idprivado_finalizar=0&idconversante="
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
                java.lang.String r1 = r5.f10068b     // Catch:{ Exception -> 0x00af }
                r0.append(r1)     // Catch:{ Exception -> 0x00af }
            ...
            L_0x00be:
                goto L_0x00bd
            */
            throw new UnsupportedOperationException("Method not decompiled: british.xnews2.t_video.C2506q.doInBackground(java.lang.String[]):java.lang.String");
        }
            ...
            if (this.f10069c != -1) {
                if (str4.indexOf("ANDROID:OK") != -1 || str4.indexOf("ANDROID:KO") != -1 || str4.indexOf("ANDROID:PERFILKO") != -1) {
                    if (str4.indexOf("ANDROID:PERFILKO") != -1) {
                        AlertDialog create = new AlertDialog.Builder(t_video.this).setPositiveButton(R.string.aceptar, new C2507a()).setMessage(R.string.perfil_desactivado).create();
                        if (!t_video.this.f6668q.equals("")) {
                            create.setOnShowListener(new C2508b(create));
                        }
                        create.show();
                        try {
                        ...
                        for (int i2 = -1; indexOf != i2; i2 = -1) {
                            ...
                            t_video.this.f10020T = Integer.parseInt(substring);
                            int i3 = indexOf3 + 1;
                            ...
                            if (str5.equals("") || substring4.equals("") || !str5.equals(substring4) || str6.equals("") || substring2.equals("") || !str6.equals(substring2)) {
                                ...
                                if (z2 || str4.indexOf("ZXRT4@1@") != -1) {
                                    ...
                                    StringBuilder sb = new StringBuilder();
                                    z = z2;
                                    sb.append(t_video.this.f10014Q);
                                    sb.append("");
                                    if (substring2.equals(sb.toString())) {
                                        ...
                                        SharedPreferences.Editor edit = t_video.this.f10007M0.edit();
                                        ...
                                        edit.putString("f2_idtema", t_video.this.f10016R + "");
                                ...
                                z2 = z;
                                SharedPreferences.Editor edit2 = t_video.this.f10007M0.edit();
                                ...
                                edit2.putString("f2_idtema", t_video.this.f10016R + "");
    ...
    /* renamed from: british.xnews2.t_video$r */
    private class C2509r extends AsyncTask<String, Void, String> {
        private C2509r() {
        }
        ...
        public String doInBackground(String... strArr) {
            Iterator<String> it = t_video.this.f10005L0.iterator();
            while (it.hasNext()) {
                try {
                    it.remove();
                    ...
                    gVar.mo48144c("idusu", new C12982f(t_video.this.f10014Q + ""));
                    gVar.mo48144c("c", new C12982f(t_video.this.f10030o0));
                    gVar.mo48144c("idtema", new C12982f(t_video.this.f10016R + ""));
        ...
        /* renamed from: b */
        public void onPostExecute(String str) {
            if (str.equals("OK") && t_video.this.f10005L0.size() > 0) {
                t_video t_video = t_video.this;
                t_video.f9993F0 = new C2509r();
                t_video.this.f9993F0.execute(new String[0]);
            }
        }
    }

    /* renamed from: british.xnews2.t_video$s */
    private class C2510s extends AsyncTask<String, Void, String> {
        ...
        public java.lang.String doInBackground(java.lang.String... r5) {
            /*
                r4 = this;
                java.lang.String r5 = r4.f10075a
                java.lang.String r0 = "0"
                if (r5 == 0) goto L_0x008c
                java.lang.String r5 = r4.f10076b
            ...
            L_0x000c:
                ...
                r1.append(r2)     // Catch:{  }
                java.lang.String r2 = r4.f10075a     // Catch:{  }
                r1.append(r2)     // Catch:{  }
                java.lang.String r2 = "_1_p.jpg?v="
                r1.append(r2)     // Catch:{  }
                java.lang.String r2 = r4.f10076b     // Catch:{  }
                r1.append(r2)     // Catch:{  }
                ...
                r4.f10077c = r2     // Catch:{ MalformedURLException -> 0x008c }
                ...
                british.xnews2.t_video r1 = british.xnews2.t_video.this     // Catch:{ MalformedURLException -> 0x008c }
                java.io.File r1 = r1.f9997H0     // Catch:{ MalformedURLException -> 0x008c }
                ...
                java.lang.String r3 = r4.f10075a     // Catch:{ MalformedURLException -> 0x008c }
                r2.append(r3)     // Catch:{ MalformedURLException -> 0x008c }
                java.lang.String r3 = ".jpg"
                r2.append(r3)     // Catch:{ MalformedURLException -> 0x008c }
                ...
                r1.<init>(r5)     // Catch:{  }
                android.graphics.Bitmap r5 = r4.f10077c     // Catch:{  }
            ...
            L_0x008c:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: british.xnews2.t_video.C2510s.doInBackground(java.lang.String[]):java.lang.String");
        }

        /* access modifiers changed from: protected */
        /* renamed from: b */
        public void onPostExecute(String str) {
            HashMap<String, Bitmap> hashMap = t_video.this.f9985B0;
            if (hashMap != null) {
                if (str == IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE) {
                    hashMap.put(this.f10075a, this.f10077c);
                    SharedPreferences.Editor edit = t_video.this.f10007M0.edit();
                    edit.putString("fperfil_" + this.f10075a, t_video.this.f9989D0.get(this.f10075a));
                    edit.commit();
                }
                int childCount = t_video.this.f10039x0.getChildCount();
                int i = 0;
                while (i < childCount) {
                    try {
                        String str2 = (String) t_video.this.f10039x0.getChildAt(i).getTag();
                        if (str2 != null && str2.equals(this.f10075a)) {
                            t_video.this.f10039x0.getChildAt(i).findViewById(R.id.pb_foto).setVisibility(8);
                            t_video.this.f10039x0.getChildAt(i).findViewById(R.id.pb_foto_inv).setVisibility(8);
                            if (str == IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE) {
                                ((ImageView) t_video.this.f10039x0.getChildAt(i).findViewById(R.id.iv_avatar_f)).setImageBitmap(this.f10077c);
                            }
                        }
                        i++;
                    } catch (Exception unused) {
                ...
                if (!t_video.this.f9987C0.equals("")) {
                    t_video t_video = t_video.this;
                    t_video.f9995G0 = new C2510s();
                    t_video.this.f9995G0.execute(new String[0]);
                }
            }
        }
        ...
        public void onPreExecute() {
            ...
            try {
                this.f10075a = (String) t_video.this.f9987C0.keySet().toArray()[0];
            } catch (Exception unused) {
                cancel(false);
            }
            String str = this.f10075a;
            if (str != null) {
                this.f10076b = t_video.this.f9987C0.get(str);
                t_video t_video = t_video.this;
                HashMap<String, String> hashMap = t_video.f9989D0;
                String str2 = this.f10075a;
                hashMap.put(str2, t_video.f9987C0.get(str2));
                t_video.this.f9987C0.remove(this.f10075a);
            }
        }
    }
    ...
    public void m8971S() {
        ...
        if (!this.f9984B.f7279W1 && (cVar = this.f9988D) != null && cVar.f6886a != null) {
    ...
    /* renamed from: T */
    public void m8972T() {
        this.f10009N0.f6689v = false;
        boolean z = this.f9986C.containsKey("desde_chat") && this.f9986C.getBoolean("desde_chat");
        if (z) {
            this.f9994G = false;
            this.f10009N0.mo7136r(false, false);
        } else {
            C1692config config = this.f9984B;
            C1855l[] lVarArr = config.f7231O1;
            int i = this.f10011O0;
            this.f9994G = lVarArr[i].f7852D;
            this.f10009N0.mo7136r(config.f7353i5, lVarArr[i].f7862I);
        }
        FullscreenVideoLayout fullscreenVideoLayout = this.f10009N0;
        boolean z2 = this.f9994G;
        fullscreenVideoLayout.f6688J = z2;
        if (z2) {
            fullscreenVideoLayout.mo7135q();
        }
        this.f10009N0.setOnPreparedListener(new C2501n());
        this.f10009N0.setOnErrorListener(new C2484a());
        try {
            this.f10009N0.mo7177k(Uri.parse(this.f9986C.getString("url")), this.f9986C.getString("ua"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        if (!z) {
            if (this.f9984B.f7347h5) {
                setRequestedOrientation(0);
            }
            if (this.f9984B.f7341g5) {
                this.f10009N0.setFullscreen(true);
            }
        }
    }

    /* renamed from: U */
    private void m8973U(Context context) {
        this.f6674w = new C2487d(context);
    }

    /* renamed from: V */
    private void m8974V(boolean z) {
        String trim = ((TextView) findViewById(R.id.c_mensaje)).getText().toString().replace("@", "").trim();
        if (!trim.equals("")) {
            if (z && this.f10018S < 600) {
                ((InputMethodManager) getSystemService("input_method")).hideSoftInputFromWindow(((TextView) findViewById(R.id.c_mensaje)).getWindowToken(), 0);
            }
            ((EditText) findViewById(R.id.c_mensaje)).setText("");
            SharedPreferences.Editor edit = this.f10007M0.edit();
            edit.putString("f2_id", this.f10014Q + "");
            ...
            edit.putString("f2_idtema", this.f10016R + "");
            edit.putString("f2_vfoto", SessionDescription.SUPPORTED_SDP_VERSION);
            edit.putBoolean("f2_ultimas", false);
            edit.putString("f2_ts", System.currentTimeMillis() + "");
            edit.commit();
            this.f9984B.mo7508i1(this);
            C1692config config = this.f9984B;
            SharedPreferences sharedPreferences = this.f10007M0;
            config.mo7501e1(this, sharedPreferences, this.f10016R + "");
            this.f10005L0.add(trim);
            C2509r rVar = this.f9993F0;
            if (rVar == null || rVar.getStatus() != AsyncTask.Status.RUNNING) {
                C2509r rVar2 = new C2509r();
                this.f9993F0 = rVar2;
    ...
    /* renamed from: W */
    public void mo9050W() {
        int q0 = this.f9984B.mo7522q0(this);
        int i = this.f9984B.f7427t4;
        int i2 = 0;
        if (i == 1) {
            ListView listView = (ListView) findViewById(R.id.left_drawer);
            this.f9992F = listView;
            this.f9984B.mo7524s(listView);
        } else if (i == 0) {
            int i3 = 0;
            int i4 = 0;
            while (true) {
                C1855l[] lVarArr = this.f9984B.f7231O1;
    ...
    public void mo9051X() {
        boolean z;
        if (!this.f10029n0.equals("")) {
            Date date = null;
            try {
                date = new SimpleDateFormat("ddMMyy").parse(this.f10029n0);
                z = true;
            } catch (Exception e) {
                e.printStackTrace();
                z = false;
            ...
            if (z) {
                ...
                this.f10039x0.addView(textView, 0);
            }
        }
    }

    public void abrir_secc(View view) {
        C1845j j0 = this.f9984B.mo7510j0(view, this);
        if (j0.f7843b) {
            this.f6669r = true;
    ...
    public void onBackPressed() {
        if (findViewById(R.id.sv_chat).getVisibility() == 0) {
            m8971S();
        } else if (!this.f6671t || this.f9996H || !this.f9984B.f7365k5) {
            super.onBackPressed();
        } else {
            this.f9996H = true;
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.btnemotic) {
            ...
            intent.putExtra("p_fnac", this.f10023W);
            intent.putExtra("p_sexo", this.f10024X);
            intent.putExtra("p_descr", this.f10025Y);
            intent.putExtra("p_dist", this.f10026Z);
            intent.putExtra("coments_chat", this.f10000J);
            intent.putExtra("galeria", this.f10002K);
            intent.putExtra("privados_chat", this.f9998I);
            intent.putExtra("fotos_perfil", this.f10021U);
            intent.putExtra("fotos_chat", this.f10022V);
            startActivityForResult(intent, 0);
        } else {
            String str9 = this.f9984B.f7251R3;
            if ((str9 == null || str9.equals("")) && (((str = this.f9984B.f7281W3) == null || str.equals("")) && (((str2 = this.f9984B.f7250R2) == null || str2.equals("")) && (((str3 = this.f9984B.f7245Q3) == null || str3.equals("")) && (((str4 = this.f9984B.f7269U3) == null || str4.equals("")) && (((str5 = this.f9984B.f7275V3) == null || str5.equals("")) && (((str6 = this.f9984B.f7358j4) == null || str6.equals("")) && (((str7 = this.f9984B.f7287X3) == null || str7.equals("")) && ((str8 = this.f9984B.f7293Y3) == null || str8.equals("")))))))))) {
                abrir_secc(view);
                return;
            }
            String str10 = this.f9984B.f7251R3;
            if (str10 != null && !str10.equals("")) {
                this.f6675x = new RewardedVideo((Context) this, this.f9984B.f7251R3);
            }
            String str11 = this.f9984B.f7245Q3;
            if (str11 != null) {
                str11.equals("");
            }
            String str12 = this.f9984B.f7269U3;
            if (str12 != null && !str12.equals("")) {
                this.f6676y = new RewardedVideoAd(this, this.f9984B.f7269U3);
            }
            String str13 = this.f9984B.f7275V3;
            ...
            this.f6672u = view;
            if (!this.f9984B.mo7494Z0(this, view, this.f6668q, progressDialog, this.f6674w, this.f6675x, this.f6676y, this.f6677z, this.f6667A, view)) {
                abrir_secc(view);
            }
        }
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        mo9050W();
        if (this.f9984B.f7427t4 == 1) {
            ((ImageView) findViewById(R.id.iv_drawer)).setOnClickListener(new C2485b());
            ((ImageView) findViewById(R.id.icohome)).setOnClickListener(new C2486c());
        }
        ((LinearLayout) findViewById(R.id.ll_ad)).removeAllViews();
        C1603c cVar2 = this.f9988D;
        ...
        this.f9988D = this.f9984B.mo7474A0(this, false);
        if (findViewById(R.id.sv_chat).getVisibility() == 0 && !this.f9984B.f7279W1 && (cVar = this.f9988D) != null && cVar.f6886a != null) {
            m8975Y();
        }
    }
    ...
    public void onCreate(Bundle bundle) {
        ...
        setTheme(2131886572);
        m8973U(this);
        this.f6667A = new C2491f();
        Bundle extras = getIntent().getExtras();
        this.f9986C = extras;
        boolean z = true;
        if (bundle == null) {
            this.f6671t = extras != null && extras.containsKey("es_root") && this.f9986C.getBoolean("es_root", false);
        } else {
            this.f6671t = bundle.containsKey("es_root") && bundle.getBoolean("es_root", false);
        }
        Bundle extras2 = getIntent().getExtras();
        this.f9986C = extras2;
        int i2 = extras2.getInt("ind");
        this.f10011O0 = i2;
        C1692config config3 = this.f9984B;
        this.f6668q = C1692config.m8189h(config3.f7231O1[i2].f7916g, config3.f7368l1);
        super.onCreate(bundle);
        setContentView((int) R.layout.t_video);
        mo9050W();
        this.f9984B.mo7486N0(this, true);
        SearchManager searchManager = (SearchManager) getSystemService("search");
        searchManager.setOnCancelListener(new C2492g());
        searchManager.setOnDismissListener(new C2493h());
        if (this.f9984B.f7427t4 == 1) {
            ((ImageView) findViewById(R.id.iv_drawer)).setOnClickListener(new C2494i());
            ((ImageView) findViewById(R.id.icohome)).setOnClickListener(new C2495j());
        }
        this.f9988D = this.f9984B.mo7474A0(this, false);
        C1692config config4 = this.f9984B;
        config4.mo7488Q0(this, config4.f7318d, this.f6668q, bundle);
        if (!this.f9984B.f7231O1[this.f10011O0].f7916g.equals("")) {
            findViewById(R.id.ll_princ).setBackgroundDrawable(new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, new int[]{Color.parseColor("#" + this.f9984B.f7231O1[this.f10011O0].f7916g), Color.parseColor("#" + this.f9984B.f7231O1[this.f10011O0].f7919h)}));
        }
        this.f10009N0 = (FullscreenVideoLayout) findViewById(R.id.vv);
        if (this.f9984B.f7353i5) {
            try {
                this.f10017R0 = C5758b.m25464e(this).mo22535c();
                C10739a.m48621b(getApplicationContext(), (MediaRouteButton) findViewById(R.id.vcv_img_cast));
            } catch (Exception unused) {
            }
        }
        SharedPreferences sharedPreferences = getSharedPreferences("sh", 0);
        this.f10007M0 = sharedPreferences;
        int i3 = sharedPreferences.getInt("appnext_video_n", 0) + 1;
        SharedPreferences.Editor edit = this.f10007M0.edit();
        edit.putInt("appnext_video_n", i3);
        edit.commit();
        if (this.f9984B.f7274V2.equals("") || i3 < (i = config.f7286X2) || (i3 - i) % (config = this.f9984B).f7280W2 != 0) {
            m8972T();
        } else {
            this.f10009N0.f6689v = true;
            new C2504p().execute(new String[0]);
        }
        if (this.f9986C.getBoolean("desde_chat", false)) {
            this.f10010O = false;
        } else {
            this.f10010O = this.f9984B.f7362k2;
        }
        C1692config config5 = this.f9984B;
        C1855l[] lVarArr = config5.f7231O1;
        int i4 = this.f10011O0;
        this.f10041z0 = lVarArr[i4].f7916g;
        this.f9983A0 = lVarArr[i4].f7919h;
        if (this.f10010O) {
            this.f10012P = true;
            int i5 = config5.f7411r2;
            int i6 = config5.f7418s2;
            int i7 = config5.f7425t2;
            this.f10021U = config5.f7404q2;
            if (this.f10007M0.getString("nick", "").equals("") || (this.f9984B.f7393o5 == 3 && !this.f10007M0.getBoolean("email_confirmado", false))) {
                this.f10012P = false;
            } else if ((this.f10021U == 2 && !this.f9984B.mo7516l0(this, 1).exists()) || ((i5 == 2 && (this.f10007M0.getInt("fnac_d", 0) == 0 || this.f10007M0.getInt("fnac_m", 0) == 0 || this.f10007M0.getInt("fnac_a", 0) == 0)) || ((i6 == 2 && this.f10007M0.getInt("sexo", 0) == 0) || (i7 == 2 && this.f10007M0.getString("descr", "").equals(""))))) {
                this.f10012P = false;
            }
            ...
            if (Build.VERSION.SDK_INT >= 13) {
                ...
                this.f10018S = point.y;
            } else {
                this.f10018S = defaultDisplay.getHeight();
            }
            this.f10004L = C1692config.m8153I("#" + this.f9984B.f7231O1[this.f10011O0].f7916g);
            this.f10006M = C1692config.m8153I("#" + this.f9984B.f7231O1[this.f10011O0].f7919h);
            C1692config config6 = this.f9984B;
            if (config6.f7338g2 > 0) {
                this.f10008N = true;
                if (!config6.f7356j2.equals("")) {
                    this.f10008N = C1692config.m8153I("#" + this.f9984B.f7356j2);
                }
            } else {
                this.f10008N = this.f10004L;
            }
            try {
                this.f10016R = this.f9984B.f7231O1[this.f10011O0].f7867K0[0].f8022a;
            } catch (Exception unused2) {
                this.f10016R = 0;
            }
            C1692config config7 = this.f9984B;
            this.f10021U = config7.f7404q2;
            this.f9998I = config7.f7376m2;
            this.f10000J = config7.f7383n2;
            this.f10002K = config7.f7390o2;
            this.f10023W = config7.f7411r2;
            this.f10024X = config7.f7418s2;
            this.f10026Z = config7.f7432u2;
            this.f10025Y = config7.f7425t2;
            DisplayMetrics displayMetrics = new DisplayMetrics();
            getWindowManager().getDefaultDisplay().getMetrics(displayMetrics);
            int i8 = displayMetrics.widthPixels;
            this.f10032q0 = i8;
            this.f10033r0 = displayMetrics.heightPixels;
            if (getResources().getConfiguration().orientation == 2) {
                i8 = this.f10033r0;
            }
            double d = (double) (i8 / 2);
            Double.isNaN(d);
            this.f10034s0 = (int) (d * 1.1d);
            double d2 = (double) i8;
            Double.isNaN(d2);
            this.f10035t0 = (int) (d2 * 0.8d);
            if (this.f10021U > 0) {
                int E = C1692config.m8149E(this, 50);
                this.f10034s0 -= E;
                this.f10035t0 -= E;
            }
            this.f10036u0 = C1692config.m8149E(this, 4);
            int i9 = this.f9984B.f7338g2;
            if (i9 == 1) {
                this.f10036u0 = C1692config.m8149E(this, 14);
            } else if (i9 == 2) {
                this.f10036u0 = C1692config.m8149E(this, 5);
            } else if (i9 == 3) {
                this.f10036u0 = C1692config.m8149E(this, 12);
            } else if (i9 == 4) {
                this.f10036u0 = C1692config.m8149E(this, 4);
            }
            this.f10037v0 = C1692config.m8149E(this, 3);
            this.f10038w0 = C1692config.m8149E(this, 10);
            if (!this.f9984B.f7291Y1) {
                findViewById(R.id.btnemotic).setVisibility(8);
            }
            this.f9999I0 = (int) ((getResources().getDisplayMetrics().density * 100.0f) + 0.5f);
            this.f10001J0 = (int) ((getResources().getDisplayMetrics().density * 3.0f) + 0.5f);
            this.f10003K0 = (int) ((getResources().getDisplayMetrics().density * 3.0f) + 0.5f);
            this.f9997H0 = getFilesDir();
            this.f10027l0 = 0;
            this.f10029n0 = "";
            this.f10028m0 = "";
            this.f10031p0 = false;
            SharedPreferences sharedPreferences2 = getSharedPreferences("sh", 0);
            this.f10007M0 = sharedPreferences2;
            this.f10014Q = sharedPreferences2.getLong("idusu", 0);
            this.f10030o0 = this.f10007M0.getString("cod", "");
            this.f10039x0 = (LinearLayout) findViewById(R.id.llchat);
            this.f10040y0 = (ProgressBar) findViewById(R.id.pb_chat_env_inv);
            if (!this.f10041z0.equals("")) {
                int i10 = Build.VERSION.SDK_INT;
                if (i10 > 20) {
                    C1692config.m8150F((EditText) findViewById(R.id.c_mensaje), Boolean.valueOf(!this.f10004L), this.f6668q);
                } else {
                ...
                if (!this.f10006M) {
                    ...
                    if (i10 > 12) {
                        this.f10040y0 = (ProgressBar) findViewById(R.id.pb_chat_env);
                    }
                }
                if (i10 > 20) {
                    C1692config.m8168S0(this.f10040y0, this.f6668q);
                }
            ...
            findViewById(R.id.rl_chat).setOnClickListener(new C2496k());
            findViewById(R.id.btn_verchat).setOnClickListener(new C2497l());
            findViewById(R.id.btn_verchat).setVisibility(0);
            this.f9985B0 = new HashMap<>();
            this.f9987C0 = new HashMap<>();
            this.f9989D0 = new HashMap<>();
            this.f9991E0 = null;
            try {
                if (this.f10008N) {
                    this.f9991E0 = BitmapFactory.decodeResource(getResources(), R.drawable.sinfoto_light);
                } else {
                    this.f9991E0 = BitmapFactory.decodeResource(getResources(), R.drawable.sinfoto);
                }
            } catch (OutOfMemoryError unused3) {
            }
            if (this.f10021U > 0) {
                File l0 = this.f9984B.mo7516l0(this, 1);
                try {
                    ...
                    if (!z) {
                        int round = Math.round(((float) i11) / ((float) C1692config.m8193n(i11, i12, 75, 100)));
                        BitmapFactory.Options options2 = new BitmapFactory.Options();
                        options2.inSampleSize = round;
                        this.f9991E0 = BitmapFactory.decodeFile(l0.getPath(), options2);
                    } else {
                        this.f9991E0 = MediaStore.Images.Media.getBitmap(getContentResolver(), Uri.fromFile(l0));
                    }
            ...
            this.f10020T = 0;
            if (this.f10012P) {
                new C2506q(SessionDescription.SUPPORTED_SDP_VERSION, SessionDescription.SUPPORTED_SDP_VERSION, this.f10020T).execute(new String[0]);
            }
        }
    }
    ...
    public void onDestroy() {
        ...
        C1603c cVar3;
        com.google.android.gms.ads.AdView adView2;
        if (!(this.f9984B.f7384n3 == 0 || (cVar3 = this.f9988D) == null || (adView2 = cVar3.f6886a) == null)) {
            adView2.destroy();
        }
        if (!(this.f9984B.f7384n3 == 0 || (cVar2 = this.f9988D) == null || (adView = cVar2.f6887b) == null)) {
            adView.destroy();
        }
        if (!(this.f9984B.f7384n3 == 0 || (cVar = this.f9988D) == null || (adColonyAdView = cVar.f6889d) == null)) {
            adColonyAdView.destroy();
        }
        if (this.f10010O && this.f10012P) {
            try {
                this.f10007M0.unregisterOnSharedPreferenceChangeListener(this);
            } catch (Exception unused) {
            }
        }
    ...
    public void onPause() {
        ...
        if (!(this.f9984B.f7384n3 == 0 || (cVar = this.f9988D) == null || (adView = cVar.f6886a) == null)) {
            adView.pause();
        }
        super.onPause();
        C1692config.m8162O0(this);
        this.f10013P0 = this.f10009N0.getCurrentPosition();
        this.f10009N0.mo7121e();
        if (this.f9984B.f7353i5) {
            try {
                C10777q qVar = this.f10017R0;
                if (qVar != null) {
                    qVar.mo42955f(this.f10019S0);
                }
                this.f10015Q0 = null;
            } catch (Exception unused) {
            }
    ...
    public void onReceiveAd(C5041Ad ad) {
        this.f6673v.cancel();
        this.f6677z.showAd("REWARDED VIDEO", new C2490e());
    }
    ...
    public void onResume() {
        ...
        C10777q qVar;
        try {
            if (this.f9984B.f7353i5 && (qVar = this.f10017R0) != null) {
                this.f10015Q0 = qVar.mo42953d();
                this.f10017R0.mo42950a(this.f10019S0);
            }
        } catch (Exception unused) {
        }
        super.onResume();
        C1692config.m8164P0(this);
        C5759d dVar = this.f10015Q0;
        if ((dVar == null || !dVar.mo42943c()) && (fullscreenVideoLayout = this.f10009N0) != null && fullscreenVideoLayout.f6717g) {
            fullscreenVideoLayout.mo7176j(this.f10013P0);
            this.f10009N0.mo7124l();
        }
        if (!(this.f9984B.f7384n3 == 0 || (cVar = this.f9988D) == null || (adView = cVar.f6886a) == null)) {
            adView.resume();
        }
        if (this.f10010O && this.f10012P) {
            this.f10007M0.registerOnSharedPreferenceChangeListener(this);
        }
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String str) {
        if (sharedPreferences.contains("f2_idfrase") && str.equals("f2_ts")) {
            SharedPreferences sharedPreferences2 = this.f10007M0;
            if (!sharedPreferences2.contains("ban_" + sharedPreferences.getString("f2_id", ""))) {
                ...
                if (string.equals(this.f10016R + "")) {
                    runOnUiThread(new C2498m(sharedPreferences));
                }
            }
        }
    }
