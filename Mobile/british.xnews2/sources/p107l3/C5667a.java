...
public final class C5667a {
    ...
    static /* synthetic */ class C5668a {
        ...
        static {
            /*
                l3.a$b[] r0 = p107l3.C5667a.C5669b.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f24252a = r0
                l3.a$b r1 = p107l3.C5667a.C5669b.CrashReport     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f24252a     // Catch:{ NoSuchFieldError -> 0x001d }
                l3.a$b r1 = p107l3.C5667a.C5669b.CrashShield     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = f24252a     // Catch:{ NoSuchFieldError -> 0x0028 }
                l3.a$b r1 = p107l3.C5667a.C5669b.ThreadCheck     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p107l3.C5667a.C5668a.<clinit>():void");
        }
    }
