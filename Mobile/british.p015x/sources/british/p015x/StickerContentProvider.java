...
/* renamed from: british.x.StickerContentProvider */
public class StickerContentProvider extends ContentProvider {

    /* renamed from: c */
    public static final Uri f6820c = new Uri.Builder().scheme("content").authority("british.x.stickercontentprovider").appendPath(TtmlNode.TAG_METADATA).build();
    ...
    private void m8083h() {
        ...
        if (f != null) {
            for (StickerPack next : f) {
                ...
                uriMatcher.addURI("british.x.stickercontentprovider", "stickers_asset/" + next.f6823b + "/" + next.f6826e, 5);
                for (Sticker sticker : next.mo7291a()) {
                    UriMatcher uriMatcher2 = f6821d;
                    uriMatcher2.addURI("british.x.stickercontentprovider", "stickers_asset/" + next.f6823b + "/" + sticker.f6817b, 4);
                }
            }
        }
    }
    ...
    private synchronized void m8084i(android.content.Context r22) {
        /*
            ...
            british.x.config r0 = (british.p015x.C1692config) r0     // Catch:{ all -> 0x01b2 }
            if (r0 == 0) goto L_0x01b0
            british.x.l[] r2 = r0.f7231O1     // Catch:{ all -> 0x01b2 }
        ...
        L_0x003f:
            ...
            r15 = 0
        L_0x0048:
            british.x.l[] r5 = r0.f7231O1     // Catch:{ all -> 0x01b2 }
            ...
            goto L_0x01a6
        L_0x0086:
            british.x.StickerPack r13 = new british.x.StickerPack     // Catch:{ all -> 0x01b2 }
        ...
        L_0x0129:
            ...
            goto L_0x0185
        L_0x0156:
            british.x.Sticker r9 = new british.x.Sticker     // Catch:{ all -> 0x01b2 }
        ...
        L_0x018a:
            ...
            java.util.List<british.x.StickerPack> r5 = r1.f6822b     // Catch:{ all -> 0x01b2 }
            r5.add(r3)     // Catch:{ all -> 0x01b2 }
            java.util.List<british.x.StickerPack> r3 = r1.f6822b     // Catch:{ all -> 0x01b2 }
        ...
        L_0x01b6:
            goto L_0x01b5
        */
        throw new UnsupportedOperationException("Method not decompiled: british.p015x.StickerContentProvider.m8084i(android.content.Context):void");
    }
    ...
    public String getType(Uri uri) {
        ...
        if (match == 1) {
            return "vnd.android.cursor.dir/vnd.british.x.stickercontentprovider.metadata";
        }
        if (match == 2) {
            return "vnd.android.cursor.item/vnd.british.x.stickercontentprovider.metadata";
        }
        if (match == 3) {
            return "vnd.android.cursor.dir/vnd.british.x.stickercontentprovider.stickers";
        }
        if (match == 4) {
            return "image/webp";
        }
    ...
    public boolean onCreate() {
        if ("british.x.stickercontentprovider".startsWith(getContext().getPackageName())) {
            UriMatcher uriMatcher = f6821d;
            uriMatcher.addURI("british.x.stickercontentprovider", TtmlNode.TAG_METADATA, 1);
            uriMatcher.addURI("british.x.stickercontentprovider", "metadata/*", 2);
            uriMatcher.addURI("british.x.stickercontentprovider", "stickers/*", 3);
            return true;
        }
        throw new IllegalStateException("your authority (british.x.stickercontentprovider) for the content provider should start with your package name: " + getContext().getPackageName());
    }
