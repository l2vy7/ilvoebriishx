...
public final class C10512b {
    ...
    /* renamed from: a */
    private static volatile ClassLoader f49034a;

    /* renamed from: b */
    private static volatile Thread f49035b;

    /* renamed from: a */
    public static synchronized ClassLoader m48242a() {
        ClassLoader classLoader;
        synchronized (C10512b.class) {
            if (f49034a == null) {
                f49034a = m48243b();
            }
            classLoader = f49034a;
    ...
    /* renamed from: b */
    private static synchronized ClassLoader m48243b() {
        String str;
        synchronized (C10512b.class) {
            ...
            synchronized (f49035b) {
                try {
                    classLoader = f49035b.getContextClassLoader();
    ...
    private static synchronized java.lang.Thread m48244c() {
        /*
            java.lang.Class<e5.b> r0 = p203e5.C10512b.class
            monitor-enter(r0)
        ...
        L_0x005e:
            ...
            e5.a r1 = new e5.a     // Catch:{ SecurityException -> 0x0070 }
        ...
        L_0x00a3:
            goto L_0x00a2
        */
        throw new UnsupportedOperationException("Method not decompiled: p203e5.C10512b.m48244c():java.lang.Thread");
    }
}
