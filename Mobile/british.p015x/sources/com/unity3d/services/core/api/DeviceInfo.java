...
public class DeviceInfo {
    ...
    static /* synthetic */ class C125722 {
        ...
        static {
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.api.DeviceInfo.C125722.<clinit>():void");
        }
    }
    ...
    private static File getFileForStorageType(StorageType storageType) {
        int i = C125722.$SwitchMap$com$unity3d$services$core$api$DeviceInfo$StorageType[storageType.ordinal()];
        if (i == 1) {
        ...
        if (sensorList != null) {
            for (Sensor next : sensorList) {
                ...
                try {
                    ...
                    jSONObject.put(SessionDescription.ATTR_TYPE, next.getType());
    ...
    public static void registerVolumeChangeListener(Integer num, WebViewCallback webViewCallback) {
        ...
        if (_volumeChangeListeners.get(num.intValue()) == null) {
            C125711 r0 = new IVolumeChangeListener(num) {
