...
public class C3504i {
    ...
    /* renamed from: a */
    private static final HashSet<String> f13118a = m11734a();

    /* renamed from: a */
    private static HashSet<String> m11734a() {
    ...
    /* renamed from: b */
    public static boolean m11735b(Context context, String str) {
        ...
        try {
            ...
            if (signatureArr != null && signatureArr.length > 0) {
                for (Signature byteArray : signatureArr) {
                    if (!f13118a.contains(C3481f0.m11645o0(byteArray.toByteArray()))) {
                        return false;
                    }
                }
                return true;
