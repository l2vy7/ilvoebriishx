...
@Keep
public abstract class NativeAdBase implements C3371Ad {
    ...
    @Keep
    public interface NativeAdLoadConfigBuilder extends C3371Ad.LoadConfigBuilder {
    ...
    @Keep
    public interface NativeLoadAdConfig extends C3371Ad.LoadAdConfig {
    }
