...
public class RatingBar extends LinearLayout {
    ...
    /* renamed from: a */
    public static Map<String, String> f54748a = new HashMap<String, String>() {
        {
    ...
    /* renamed from: a */
    public final void mo46488a(String str) {
        try {
            int a = C11970ib.m52467a(getContext(), 2);
            int a2 = C11970ib.m52467a(getContext(), 5);
            ImageView imageView = new ImageView(getContext());
            Bitmap a3 = C11812c1.m52082a(getContext(), str);
            if (a3 == null) {
                a3 = C11878e1.m52261a((String) ((HashMap) f54748a).get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(a3, C11970ib.m52467a(getContext(), 15), C11970ib.m52467a(getContext(), 15), true));
    ...
    public void setRating(float f) {
        ...
        for (int i3 = 0; i3 < floor; i3++) {
            mo46488a("filled_star.png");
        }
        if (i != 0) {
            mo46488a("half_star.png");
        }
        for (int i4 = 0; i4 < i2; i4++) {
            mo46488a("empty_star.png");
        }
    }
}
