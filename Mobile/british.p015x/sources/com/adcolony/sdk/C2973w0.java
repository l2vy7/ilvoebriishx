...
class C2973w0 {
    ...
    /* renamed from: a */
    private static int f11938a;

    /* renamed from: b */
    private static int f11939b;

    /* renamed from: c */
    private static int f11940c;

    /* renamed from: d */
    private static int f11941d;

    /* renamed from: com.adcolony.sdk.w0$a */
    private static class C2974a {
        private C2974a() {
        }

        /* renamed from: a */
        static int m10297a(WindowManager windowManager) {
    ...
    private static class C2975b {
        private C2975b() {
        }

        /* renamed from: a */
        static int m10298a(WindowManager windowManager) {
            Point point = new Point();
            windowManager.getDefaultDisplay().getSize(point);
            return point.x;
        }
    ...
    static float m10288a(android.view.View r9, android.content.Context r10, boolean r11, boolean r12, boolean r13, boolean r14) {
        /*
            r0 = 0
        ...
        L_0x0007:
            ...
            float r1 = m10294b((android.view.View) r9)
        ...
        L_0x002c:
            ...
            int r7 = r7 + r8
            r6[r2] = r7
            int r7 = m10291a((android.content.Context) r10)
            int r10 = m10295b((android.content.Context) r10)
            r8 = r6[r1]
        ...
        L_0x0092:
            ...
            float r9 = m10289a(r9, r3, r10, r1)     // Catch:{ Exception -> 0x00b3 }
        ...
        L_0x00c3:
            ...
            r8 = r3[r2]
            r4.<init>(r5, r6, r7, r8)
            int r5 = m10291a((android.content.Context) r10)
            int r10 = m10295b((android.content.Context) r10)
            r6 = r3[r1]
        ...
        L_0x011c:
            ...
            float r9 = m10289a(r9, r4, r10, r2)     // Catch:{ Exception -> 0x0138 }
        ...
        L_0x0147:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C2973w0.m10288a(android.view.View, android.content.Context, boolean, boolean, boolean, boolean):float");
    }

    /* renamed from: b */
    private static float m10294b(View view) {
        if (view == null) {
            return 0.0f;
        }
        if (m10290a() < 11) {
    ...
    /* renamed from: c */
    private static boolean m10296c(View view) {
        if (view == null) {
            return false;
        }
        if (view.getBackground() == null || (m10290a() > 18 && view.getBackground().getAlpha() == 0)) {
            return true;
        }
        return false;
    }
    ...
    /* renamed from: b */
    private static int m10295b(Context context) {
        int i;
        int i2;
        int i3;
        int i4 = context != null ? context.getResources().getConfiguration().orientation : -1;
        if (i4 == 2 && (i3 = f11939b) > 0) {
            return i3;
        }
        if (i4 == 1 && (i2 = f11941d) > 0) {
            return i2;
        }
        try {
            WindowManager windowManager = (WindowManager) context.getApplicationContext().getSystemService("window");
            if (m10290a() >= 13) {
                i = C2975b.m10298a(windowManager);
            } else {
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static float m10289a(android.view.View r11, android.graphics.Rect r12, float r13, boolean r14) {
        /*
        ...
        L_0x0035:
            ...
            float r8 = m10294b((android.view.View) r5)
        ...
        L_0x00a9:
            ...
            boolean r10 = m10296c(r9)
            if (r10 != 0) goto L_0x00cc
            int r10 = r9.getVisibility()
            if (r10 != 0) goto L_0x00a9
            float r10 = m10294b((android.view.View) r9)
            int r10 = (r10 > r7 ? 1 : (r10 == r7 ? 0 : -1))
            if (r10 == 0) goto L_0x00a9
            r3.addFirst(r9)
            goto L_0x00a9
        L_0x00cc:
            java.util.ArrayList r9 = m10293a((android.view.View) r9)
        ...
        L_0x0173:
            ...
            android.graphics.Rect r8 = m10292a(r1, r12, r3)
            int r9 = r8.height()
        ...
        L_0x01b9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C2973w0.m10289a(android.view.View, android.graphics.Rect, float, boolean):float");
    }

    /* renamed from: a */
    private static Rect m10292a(Rect rect, Rect rect2, int i) {
        Rect rect3 = new Rect();
        switch (i) {
            case 1:
    ...
    /* renamed from: a */
    private static ArrayList<View> m10293a(View view) {
        if ((view instanceof ViewGroup) && view.getVisibility() == 0 && m10294b(view) != 0.0f) {
            ...
            while (listIterator.hasNext()) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (childAt.getVisibility() == 0 && m10294b(childAt) != 0.0f) {
    ...
    /* renamed from: a */
    private static int m10291a(Context context) {
        int i;
        int i2;
        int i3;
        int i4 = context != null ? context.getResources().getConfiguration().orientation : -1;
        if (i4 == 2 && (i3 = f11938a) > 0) {
            return i3;
        }
        if (i4 == 1 && (i2 = f11940c) > 0) {
            return i2;
        }
        try {
            WindowManager windowManager = (WindowManager) context.getApplicationContext().getSystemService("window");
            if (m10290a() >= 13) {
                i = C2974a.m10297a(windowManager);
            } else {
