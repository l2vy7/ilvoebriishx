...
/* renamed from: com.ironsource.environment.l */
public final class C4985l {

    /* renamed from: a */
    public static final ArrayList<String> f22055a = new ArrayList<>(Arrays.asList(new String[]{"applicationUserAgeGroup", "uAge", "advId", "appKey", "mCar", "medV", "connT", "dWidth", "dHeight", "dModel", "cTime", "sDepRV", "sDepIS", "sId", "plType", "dOSV", "dOSVF", "dOS", "dMake", "dAPI", "bId", "appV", "usId", "bat", "root", "diskFS", "dLang", "MD", "uGen", "advType", "isLAT", "dVol", "consent", "dHeight", "dWidth", "dScrenScle", "auid", "UA", "asid"}));

    /* renamed from: b */
    public static final HashMap<String, String> f22056b = new C4986a();

    /* renamed from: com.ironsource.environment.l$a */
    static class C4986a extends HashMap<String, String> {
        C4986a() {
