...
public final class C4943a extends SQLiteOpenHelper {

    /* renamed from: f */
    private static C4943a f21951f;

    /* renamed from: b */
    private final int f21952b = 4;

    /* renamed from: c */
    private final int f21953c = 400;

    /* renamed from: d */
    private final String f21954d = "DROP TABLE IF EXISTS events";

    /* renamed from: e */
    private final String f21955e = "CREATE TABLE events (_id INTEGER PRIMARY KEY,eventid INTEGER,timestamp INTEGER,type TEXT,data TEXT )";

    private C4943a(Context context, String str, int i) {
        super(context, str, (SQLiteDatabase.CursorFactory) null, i);
    }

    /* renamed from: a */
    public static synchronized C4943a m22681a(Context context, String str, int i) {
        C4943a aVar;
        synchronized (C4943a.class) {
            if (f21951f == null) {
                f21951f = new C4943a(context, str, 5);
            }
            aVar = f21951f;
        }
        return aVar;
    ...
    /* renamed from: c */
    private synchronized SQLiteDatabase m22682c(boolean z) {
        int i = 0;
        while (true) {
            if (z) {
                try {
    ...
    public final synchronized java.util.ArrayList<com.ironsource.mediationsdk.adunit.p277a.C11308a> mo20534a(java.lang.String r13) {
        /*
            r12 = this;
            monitor-enter(r12)
            ...
            r1 = 0
            r2 = 0
            android.database.sqlite.SQLiteDatabase r11 = r12.m22682c(r1)     // Catch:{ all -> 0x0075 }
        ...
        L_0x0028:
            ...
            com.ironsource.mediationsdk.adunit.a.a r5 = new com.ironsource.mediationsdk.adunit.a.a     // Catch:{ all -> 0x0073 }
        ...
        L_0x00b0:
            goto L_0x00af
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.p055b.C4943a.mo20534a(java.lang.String):java.util.ArrayList");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final synchronized void mo20535a(java.util.List<com.ironsource.mediationsdk.adunit.p277a.C11308a> r8, java.lang.String r9) {
        /*
            r7 = this;
            monitor-enter(r7)
        ...
        L_0x000b:
            r0 = 1
            r1 = 0
            android.database.sqlite.SQLiteDatabase r0 = r7.m22682c(r0)     // Catch:{ all -> 0x006d }
        ...
        L_0x0094:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.p055b.C4943a.mo20535a(java.util.List, java.lang.String):void");
    }

    /* renamed from: b */
    public final synchronized void mo20536b(String str) {
        SQLiteDatabase sQLiteDatabase = null;
        String[] strArr = {str};
        try {
            sQLiteDatabase = m22682c(true);
