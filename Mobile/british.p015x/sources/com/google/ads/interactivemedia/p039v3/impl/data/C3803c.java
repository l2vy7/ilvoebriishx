...
import com.google.ads.interactivemedia.p039v3.api.UniversalAdId;
import com.google.ads.interactivemedia.p039v3.internal.bnh;
import com.google.ads.interactivemedia.p039v3.internal.bni;
import com.google.ads.interactivemedia.p039v3.internal.bnj;
import com.google.ads.interactivemedia.p039v3.internal.bnk;
...
public final class C3803c implements C3759Ad {
    private String adId;
    @bni
    @bnk
    private C3804d adPodInfo = new C3804d();
    ...
    @bni
    @bnk
    private C3800bm[] universalAdIds;
    ...
    public boolean equals(Object obj) {
        return bnh.m16832c(this, obj, "vastMediaBitrate", "vastMediaHeight", "vastMediaWidth");
    }
    ...
    public List<CompanionAd> getCompanionAds() {
        ...
        for (CompanionAdImpl add : this.companions) {
            arrayList.add(add);
        }
        return arrayList;
    }
    ...
    public void setAdPodInfo(C3804d dVar) {
        this.adPodInfo = dVar;
    }
    ...
    public void setUniversalAdIds(C3800bm[] bmVarArr) {
    ...
    public String toString() {
        ...
        double d3 = d2;
        StringBuilder sb = new StringBuilder(length + 542 + length2 + length3 + length4 + length5 + length6 + length7 + length8 + length9 + length10 + length11 + length12 + length13 + length14 + length15 + length16 + length17 + str16.length() + valueOf2.length());
        sb.append("Ad [adId=");
        sb.append(str);
