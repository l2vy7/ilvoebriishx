...
final class ayl extends axb<bbc, bbb> {

    /* renamed from: a */
    final /* synthetic */ aym f15905a;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ayl(aym aym, Class cls) {
        super(cls);
        this.f15905a = aym;
    }
