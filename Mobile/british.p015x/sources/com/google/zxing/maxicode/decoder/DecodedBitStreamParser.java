...
final class DecodedBitStreamParser {
    ...
    /* renamed from: FS */
    private static final char f48981FS = '\u001c';

    /* renamed from: GS */
    private static final char f48982GS = '\u001d';
    private static final char LATCHA = '￷';
    private static final char LATCHB = '￸';
    private static final char LOCK = '￹';

    /* renamed from: NS */
    private static final char f48983NS = '￻';
    private static final char PAD = '￼';

    /* renamed from: RS */
    private static final char f48984RS = '\u001e';
    ...
    static DecoderResult decode(byte[] bArr, int i) {
        ...
        if (i == 2 || i == 3) {
            ...
            if (sb.toString().startsWith("[)>\u001e01\u001d")) {
                sb.insert(9, str + f48982GS + format + f48982GS + format2 + f48982GS);
            } else {
                sb.insert(0, str + f48982GS + format + f48982GS + format2 + f48982GS);
            }
        } else if (i == 4) {
