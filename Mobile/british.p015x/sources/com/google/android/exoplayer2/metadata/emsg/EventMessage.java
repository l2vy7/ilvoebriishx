...
public final class EventMessage implements Metadata.Entry {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.durationMs != eventMessage.durationMs || this.f27466id != eventMessage.f27466id || !Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) || !Util.areEqual(this.value, eventMessage.value) || !Arrays.equals(this.messageData, eventMessage.messageData)) {
            return false;
        }
        return true;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeLong(this.f27466id);
