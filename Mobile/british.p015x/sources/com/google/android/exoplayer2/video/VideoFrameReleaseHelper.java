...
public final class VideoFrameReleaseHelper {
    ...
    private static final class VSyncSampler implements Choreographer.FrameCallback, Handler.Callback {
        ...
        public volatile long sampledVsyncTimeNs = C6540C.TIME_UNSET;
        ...
        private void removeObserverInternal() {
            ...
            if (i == 0) {
                ...
                this.sampledVsyncTimeNs = C6540C.TIME_UNSET;
            }
        }
    ...
    public VideoFrameReleaseHelper(Context context) {
        ...
        this.vsyncDurationNs = C6540C.TIME_UNSET;
        this.vsyncOffsetNs = C6540C.TIME_UNSET;
    ...
    private static void setSurfaceFrameRateV30(Surface surface2, float f) {
        try {
            ...
            Log.m19794e(TAG, "Failed to call Surface.setFrameRate", e);
        }
    }
    ...
    public void updateDefaultDisplayRefreshRateParams() {
        ...
        Log.m19797w(TAG, "Unable to query display refresh rate");
        this.vsyncDurationNs = C6540C.TIME_UNSET;
        this.vsyncOffsetNs = C6540C.TIME_UNSET;
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:30:0x006c, code lost:
        if (r8.frameRateEstimator.getFramesWithoutSyncCount() >= 30) goto L_0x006e;
     */
    ...
    private void updateSurfacePlaybackFrameRate(boolean z) {
        ...
        if (Util.SDK_INT >= 30 && (surface2 = this.surface) != null) {
            ...
            if (z || this.surfacePlaybackFrameRate != f) {
                ...
                setSurfaceFrameRateV30(surface2, f);
            }
        }
    }
