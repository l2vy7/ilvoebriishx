...
public final class Tx3gDecoder extends SimpleSubtitleDecoder {
    ...
    public Tx3gDecoder(List<byte[]> list) {
        ...
        if (list.size() == 1 && (list.get(0).length == 48 || list.get(0).length == 53)) {
            ...
            this.defaultFontFamily = TX3G_SERIF.equals(Util.fromUtf8Bytes(bArr, 43, bArr.length - 43)) ? C6540C.SERIF_NAME : str;
            int i = bArr[25] * 20;
    ...
    private static String readSubtitleText(ParsableByteArray parsableByteArray2) throws SubtitleDecoderException {
        ...
        if (parsableByteArray2.bytesLeft() < 2 || ((peekChar = parsableByteArray2.peekChar()) != 65279 && peekChar != 65534)) {
            return parsableByteArray2.readString(readUnsignedShort, C11001d.f49947c);
        }
        return parsableByteArray2.readString(readUnsignedShort, C11001d.f49950f);
    }
