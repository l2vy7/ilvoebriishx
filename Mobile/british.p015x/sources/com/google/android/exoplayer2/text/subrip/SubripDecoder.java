        ...
        while (true) {
            ...
            if (readLine == null) {
                ...
                try {
                    ...
                    if (readLine2 == null) {
                        Log.m19797w(TAG, "Unexpected end");
                        break;
                    }
                    ...
                    if (matcher.matches()) {
                        ...
                        Log.m19797w(TAG, readLine2.length() != 0 ? "Skipping invalid timing: ".concat(readLine2) : new String("Skipping invalid timing: "));
                    }
                } catch (NumberFormatException unused) {
                    Log.m19797w(TAG, readLine.length() != 0 ? "Skipping invalid index: ".concat(readLine) : new String("Skipping invalid index: "));
                }
            }
        }
