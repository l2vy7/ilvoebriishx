...
final class TtmlNode {
    ...
    public static TtmlNode buildTextNode(String str) {
        return new TtmlNode((String) null, TtmlRenderUtil.applyTextElementSpacePolicy(str), C6540C.TIME_UNSET, C6540C.TIME_UNSET, (TtmlStyle) null, (String[]) null, "", (String) null, (TtmlNode) null);
    }
    ...
    public boolean isActive(long j) {
        ...
        return (j2 == C6540C.TIME_UNSET && this.endTimeUs == C6540C.TIME_UNSET) || (j2 <= j && this.endTimeUs == C6540C.TIME_UNSET) || ((j2 == C6540C.TIME_UNSET && j < this.endTimeUs) || (j2 <= j && j < this.endTimeUs));
    }
}
