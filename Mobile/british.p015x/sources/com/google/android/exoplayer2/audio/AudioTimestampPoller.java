...
final class AudioTimestampPoller {
    ...
    private void updateState(int i) {
        ...
        if (i == 0) {
            ...
            this.sampleIntervalUs = ImaAdsLoader.Builder.DEFAULT_AD_PRELOAD_TIMEOUT_MS;
        } else if (i == 1) {
            this.sampleIntervalUs = ImaAdsLoader.Builder.DEFAULT_AD_PRELOAD_TIMEOUT_MS;
        } else if (i == 2 || i == 3) {
    ...
    public long getTimestampSystemTimeUs() {
        AudioTimestampV19 audioTimestampV19 = this.audioTimestamp;
        return audioTimestampV19 != null ? audioTimestampV19.getTimestampSystemTimeUs() : C6540C.TIME_UNSET;
    }
