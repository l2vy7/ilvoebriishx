...
public final class CacheDataSink implements DataSink {
    ...
    private void openNextOutputStream(DataSpec dataSpec2) throws IOException {
        ...
        this.file = this.cache.startFile((String) Util.castNonNull(dataSpec2.key), dataSpec2.position + this.dataSpecBytesWritten, j2);
    ...
    public CacheDataSink(Cache cache2, long j, int i) {
        ...
        if (j != -1 && j < MIN_RECOMMENDED_FRAGMENT_SIZE) {
            Log.m19797w(TAG, "fragmentSize is below the minimum recommended value of 2097152. This may cause poor cache performance.");
        }
