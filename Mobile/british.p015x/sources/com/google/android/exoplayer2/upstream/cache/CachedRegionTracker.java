...
public final class CachedRegionTracker implements Cache.Listener {
    ...
    public synchronized int getRegionEndTimeMs(long r9) {
        /*
            r8 = this;
            monitor-enter(r8)
            com.google.android.exoplayer2.upstream.cache.CachedRegionTracker$Region r0 = r8.lookupRegion     // Catch:{ all -> 0x0052 }
            r0.startOffset = r9     // Catch:{ all -> 0x0052 }
            java.util.TreeSet<com.google.android.exoplayer2.upstream.cache.CachedRegionTracker$Region> r1 = r8.regions     // Catch:{ all -> 0x0052 }
            java.lang.Object r0 = r1.floor(r0)     // Catch:{ all -> 0x0052 }
            com.google.android.exoplayer2.upstream.cache.CachedRegionTracker$Region r0 = (com.google.android.exoplayer2.upstream.cache.CachedRegionTracker.Region) r0     // Catch:{ all -> 0x0052 }
            r1 = -1
            if (r0 == 0) goto L_0x0050
            long r2 = r0.endOffset     // Catch:{ all -> 0x0052 }
            int r4 = (r9 > r2 ? 1 : (r9 == r2 ? 0 : -1))
            if (r4 > 0) goto L_0x0050
            int r9 = r0.endOffsetIndex     // Catch:{ all -> 0x0052 }
            if (r9 != r1) goto L_0x001b
            goto L_0x0050
        L_0x001b:
            com.google.android.exoplayer2.extractor.ChunkIndex r10 = r8.chunkIndex     // Catch:{ all -> 0x0052 }
            int r0 = r10.length     // Catch:{ all -> 0x0052 }
            int r0 = r0 + -1
            if (r9 != r0) goto L_0x0034
            long[] r0 = r10.offsets     // Catch:{ all -> 0x0052 }
            r4 = r0[r9]     // Catch:{ all -> 0x0052 }
            int[] r0 = r10.sizes     // Catch:{ all -> 0x0052 }
            ...
            return r9
        L_0x0034:
            long[] r0 = r10.durationsUs     // Catch:{ all -> 0x0052 }
            r4 = r0[r9]     // Catch:{ all -> 0x0052 }
            long[] r0 = r10.offsets     // Catch:{ all -> 0x0052 }
            ...
            long r4 = r4 / r0
            long[] r10 = r10.timesUs     // Catch:{ all -> 0x0052 }
    ...
    public synchronized void onSpanRemoved(com.google.android.exoplayer2.upstream.cache.Cache r7, com.google.android.exoplayer2.upstream.cache.CacheSpan r8) {
        /*
            ...
            com.google.android.exoplayer2.util.Log.m19793e(r7, r8)     // Catch:{ all -> 0x0061 }
            monitor-exit(r6)
            return
        L_0x001e:
