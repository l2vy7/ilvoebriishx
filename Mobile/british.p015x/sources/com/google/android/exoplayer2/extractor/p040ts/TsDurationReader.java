...
final class TsDurationReader {
    private long durationUs = C6540C.TIME_UNSET;
    private long firstPcrValue = C6540C.TIME_UNSET;
    private boolean isDurationRead;
    private boolean isFirstPcrValueRead;
    private boolean isLastPcrValueRead;
    private long lastPcrValue = C6540C.TIME_UNSET;
    ...
    public int readDuration(ExtractorInput extractorInput, PositionHolder positionHolder, int i) throws IOException {
        ...
        if (this.lastPcrValue == C6540C.TIME_UNSET) {
            return finishReadDuration(extractorInput);
        }
