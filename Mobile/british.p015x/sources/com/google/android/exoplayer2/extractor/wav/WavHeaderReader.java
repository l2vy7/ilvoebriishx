...
final class WavHeaderReader {
    ...
    public static WavHeader peek(ExtractorInput extractorInput) throws IOException {
        ...
        if (ChunkHeader.peek(extractorInput, parsableByteArray).f27430id != 1380533830) {
            return null;
        }
        ...
        while (peek.f27430id != 1718449184) {
