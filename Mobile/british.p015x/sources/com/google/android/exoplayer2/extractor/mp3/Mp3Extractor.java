...
public final class Mp3Extractor implements Extractor {
    public static final ExtractorsFactory FACTORY = C6701a.f27416a;
    ...
    private static final Id3Decoder.FramePredicate REQUIRED_ID3_FRAME_PREDICATE = C6702b.f27417a;
    ...
    private static long getId3TlenUs(Metadata metadata2) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (entry instanceof TextInformationFrame) {
                ...
                if (textInformationFrame.f27472id.equals("TLEN")) {
                    return C6540C.msToUs(Long.parseLong(textInformationFrame.value));
                }
            }
        }
        return C6540C.TIME_UNSET;
    ...
    private int readSample(ExtractorInput extractorInput) throws IOException {
        if (this.sampleBytesRemaining == 0) {
            ...
            if (this.basisTimeUs == C6540C.TIME_UNSET) {
                this.basisTimeUs = this.seeker.getTimeUs(extractorInput.getPosition());
                if (this.forcedFirstSampleTimestampUs != C6540C.TIME_UNSET) {
    ...
    public void seek(long j, long j2) {
        this.synchronizedHeaderData = 0;
        this.basisTimeUs = C6540C.TIME_UNSET;
        this.samplesRead = 0;
        this.sampleBytesRemaining = 0;
        this.seekTimeUs = j2;
        Seeker seeker2 = this.seeker;
