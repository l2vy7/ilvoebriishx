...
public final class HttpMediaDrmCallback implements MediaDrmCallback {
    ...
    public byte[] executeKeyRequest(UUID uuid, ExoMediaDrm.KeyRequest keyRequest) throws MediaDrmCallbackException {
        ...
        if (!TextUtils.isEmpty(licenseServerUrl)) {
            ...
            UUID uuid2 = C6540C.PLAYREADY_UUID;
            if (uuid2.equals(uuid)) {
                str = "text/xml";
            } else {
                str = C6540C.CLEARKEY_UUID.equals(uuid) ? "application/json" : "application/octet-stream";
            }
        ...
        throw new MediaDrmCallbackException(new DataSpec.Builder().setUri(Uri.EMPTY).build(), Uri.EMPTY, C4776v.m22050o(), 0, new IllegalStateException("No license URL"));
    }
