...
final class SpannedToHtmlConverter {
    ...
    private static final class SpanInfo {
        ...
        public static final Comparator<SpanInfo> FOR_CLOSING_TAGS = C6968j.f27639b;
        /* access modifiers changed from: private */
        public static final Comparator<SpanInfo> FOR_OPENING_TAGS = C6966i.f27637b;
    ...
    public static HtmlAndCss convert(CharSequence charSequence, float f) {
        if (charSequence == null) {
            return new HtmlAndCss("", C4776v.m22050o());
        }
        if (!(charSequence instanceof Spanned)) {
            return new HtmlAndCss(escapeHtml(charSequence), C4776v.m22050o());
        }
