...
public class TrackSelectionView extends LinearLayout {
        ...
        while (true) {
            ...
            if (i < trackGroupArray.length) {
                ...
                for (int i4 = 0; i4 < i2; i4++) {
                    if (i4 == 0) {
                        addView(this.inflater.inflate(C6934R.layout.exo_list_divider, this, false));
                    }
    ...
    public void init(MappingTrackSelector.MappedTrackInfo mappedTrackInfo2, int i, boolean z, List<DefaultTrackSelector.SelectionOverride> list, Comparator<Format> comparator, TrackSelectionListener trackSelectionListener) {
        C6967i0 i0Var;
        ...
        if (comparator == null) {
            ...
            i0Var = new C6967i0(comparator);
        }
        this.trackInfoComparator = i0Var;
    ...
    public TrackSelectionView(Context context, AttributeSet attributeSet, int i) {
        ...
        checkedTextView.setText(C6934R.string.exo_track_selection_none);
        checkedTextView.setEnabled(false);
        checkedTextView.setFocusable(true);
        checkedTextView.setOnClickListener(componentListener2);
        checkedTextView.setVisibility(8);
        addView(checkedTextView);
        addView(from.inflate(C6934R.layout.exo_list_divider, this, false));
        CheckedTextView checkedTextView2 = (CheckedTextView) from.inflate(17367055, this, false);
        this.defaultView = checkedTextView2;
        checkedTextView2.setBackgroundResource(resourceId);
        checkedTextView2.setText(C6934R.string.exo_track_selection_auto);
