            ...
            if (paddingBottom > paddingTop && width > paddingLeft) {
                ...
                if (resolveTextSize > 0.0f) {
                    ...
                    while (i2 < size) {
                        ...
                        this.painters.get(i2).draw(cue2, this.style, f, SubtitleViewUtils.resolveTextSize(cue2.textSizeType, cue2.textSize, height, i), this.bottomPaddingFraction, canvas, paddingLeft, paddingTop, width, i3);
                        i2++;
                        size = size;
                        i = i;
                        paddingBottom = i3;
