...
import com.google.android.exoplayer2.p041ui.TimeBar;
...
public class DefaultTimeBar extends View implements TimeBar {
    ...
    private void drawTimeBar(Canvas canvas) {
        ...
        if (this.adGroupCount != 0) {
            ...
            for (int i6 = 0; i6 < this.adGroupCount; i6++) {
                long constrainValue = Util.constrainValue(jArr[i6], 0, this.duration);
    ...
    private long getScrubberPosition() {
        if (this.progressBar.width() <= 0 || this.duration == C6540C.TIME_UNSET) {
            return 0;
        }
    ...
    private void update() {
        ...
        if (this.duration > 0) {
            int width = (int) ((((long) this.progressBar.width()) * this.bufferedPosition) / this.duration);
            Rect rect = this.bufferedBar;
            Rect rect2 = this.progressBar;
            rect.right = Math.min(rect2.left + width, rect2.right);
            int width2 = (int) ((((long) this.progressBar.width()) * j) / this.duration);
            Rect rect3 = this.scrubberBar;
            Rect rect4 = this.progressBar;
    ...
    public boolean onKeyDown(int r5, android.view.KeyEvent r6) {
        ...
        L_0x0030:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p041ui.DefaultTimeBar.onKeyDown(int, android.view.KeyEvent):boolean");
    }
    ...
    public boolean onTouchEvent(android.view.MotionEvent r8) {
        ...
        L_0x0076:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.exoplayer2.p041ui.DefaultTimeBar.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public void setDuration(long j) {
        this.duration = j;
        if (this.scrubbing && j == C6540C.TIME_UNSET) {
            stopScrubbing(true);
        }
        update();
    }
    ...
    public void setKeyCountIncrement(int i) {
        ...
        this.keyTimeIncrement = C6540C.TIME_UNSET;
    }
    ...
    public DefaultTimeBar(Context context, AttributeSet attributeSet, int i, AttributeSet attributeSet2, int i2) {
        ...
        if (attributeSet3 != null) {
            Paint paint7 = paint4;
            Paint paint8 = paint5;
            TypedArray obtainStyledAttributes = context.getTheme().obtainStyledAttributes(attributeSet3, C6934R.styleable.DefaultTimeBar, i, i2);
            try {
                Drawable drawable = obtainStyledAttributes.getDrawable(C6934R.styleable.DefaultTimeBar_scrubber_drawable);
                this.scrubberDrawable = drawable;
                if (drawable != null) {
                    setDrawableLayoutDirection(drawable);
                    dpToPx2 = Math.max(drawable.getMinimumHeight(), dpToPx2);
                }
                this.barHeight = obtainStyledAttributes.getDimensionPixelSize(C6934R.styleable.DefaultTimeBar_bar_height, dpToPx);
                this.touchTargetHeight = obtainStyledAttributes.getDimensionPixelSize(C6934R.styleable.DefaultTimeBar_touch_target_height, dpToPx2);
                this.barGravity = obtainStyledAttributes.getInt(C6934R.styleable.DefaultTimeBar_bar_gravity, 0);
                this.adMarkerWidth = obtainStyledAttributes.getDimensionPixelSize(C6934R.styleable.DefaultTimeBar_ad_marker_width, dpToPx3);
                this.scrubberEnabledSize = obtainStyledAttributes.getDimensionPixelSize(C6934R.styleable.DefaultTimeBar_scrubber_enabled_size, dpToPx4);
                this.scrubberDisabledSize = obtainStyledAttributes.getDimensionPixelSize(C6934R.styleable.DefaultTimeBar_scrubber_disabled_size, dpToPx5);
                this.scrubberDraggedSize = obtainStyledAttributes.getDimensionPixelSize(C6934R.styleable.DefaultTimeBar_scrubber_dragged_size, dpToPx6);
                int i3 = obtainStyledAttributes.getInt(C6934R.styleable.DefaultTimeBar_played_color, -1);
                int i4 = obtainStyledAttributes.getInt(C6934R.styleable.DefaultTimeBar_scrubber_color, -1);
                int i5 = obtainStyledAttributes.getInt(C6934R.styleable.DefaultTimeBar_buffered_color, DEFAULT_BUFFERED_COLOR);
                int i6 = obtainStyledAttributes.getInt(C6934R.styleable.DefaultTimeBar_unplayed_color, DEFAULT_UNPLAYED_COLOR);
                int i7 = obtainStyledAttributes.getInt(C6934R.styleable.DefaultTimeBar_ad_marker_color, DEFAULT_AD_MARKER_COLOR);
                int i8 = obtainStyledAttributes.getInt(C6934R.styleable.DefaultTimeBar_played_ad_marker_color, DEFAULT_PLAYED_AD_MARKER_COLOR);
                paint.setColor(i3);
                paint6.setColor(i4);
                paint2.setColor(i5);
                paint3.setColor(i6);
        ...
        this.stopScrubbingRunnable = new C6954c(this);
        ...
        valueAnimator.addUpdateListener(new C6952b(this));
        this.duration = C6540C.TIME_UNSET;
        this.keyTimeIncrement = C6540C.TIME_UNSET;
