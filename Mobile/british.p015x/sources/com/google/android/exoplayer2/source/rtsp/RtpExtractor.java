...
final class RtpExtractor implements Extractor {
    ...
    private volatile long firstTimestamp = C6540C.TIME_UNSET;
    private boolean isSeekPending;
    private final Object lock = new Object();
    private long nextRtpTimestamp = C6540C.TIME_UNSET;
    private ExtractorOutput output;
    private final RtpPayloadReader payloadReader;
    private long playbackStartTimeUs = C6540C.TIME_UNSET;
    ...
    public void init(ExtractorOutput extractorOutput) {
        ...
        extractorOutput.seekMap(new SeekMap.Unseekable(C6540C.TIME_UNSET));
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (!this.firstPacketRead) {
            if (this.firstTimestamp == C6540C.TIME_UNSET) {
        ...
        synchronized (this.lock) {
            ...
            } else if (!(this.nextRtpTimestamp == C6540C.TIME_UNSET || this.playbackStartTimeUs == C6540C.TIME_UNSET)) {
                this.reorderingQueue.reset();
                this.payloadReader.seek(this.nextRtpTimestamp, this.playbackStartTimeUs);
                this.isSeekPending = false;
                this.nextRtpTimestamp = C6540C.TIME_UNSET;
                this.playbackStartTimeUs = C6540C.TIME_UNSET;
            }
        }
        return 0;
    }
