...
public final class RtpPacket {
    ...
    public static final class Builder {
        ...
        public Builder setSequenceNumber(int i) {
            ...
            this.sequenceNumber = i & RtpPacket.MAX_SEQUENCE_NUMBER;
            return this;
        }
    ...
    public int writeToBuffer(byte[] bArr, int i, int i2) {
        ...
        ByteBuffer.wrap(bArr, i, i2).put((byte) (((this.padding ? 1 : 0) << true) | C12425x3.f55111d | ((this.extension ? 1 : 0) << true) | (this.csrcCount & 15))).put((byte) (((this.marker ? 1 : 0) << true) | (this.payloadType & Byte.MAX_VALUE))).putShort((short) this.sequenceNumber).putInt((int) this.timestamp).putInt(this.ssrc).put(this.csrc).put(this.payloadData);
        return length;
    }
