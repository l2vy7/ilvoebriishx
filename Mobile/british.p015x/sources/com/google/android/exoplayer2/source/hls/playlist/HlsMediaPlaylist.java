...
public final class HlsMediaPlaylist extends HlsPlaylist {
    ...
    public HlsMediaPlaylist(int i, String str, List<String> list, long j, long j2, boolean z, int i2, long j3, int i3, long j4, long j5, boolean z2, boolean z3, boolean z4, DrmInitData drmInitData, List<Segment> list2, List<Part> list3, ServerControl serverControl2, Map<Uri, RenditionReport> map) {
        ...
        this.segments = C4766t.m21988y(list2);
        this.trailingParts = C4766t.m21988y(list3);
        this.renditionReports = C4776v.m22049f(map);
        if (!list3.isEmpty()) {
            Part part = (Part) C4706d0.m21756c(list3);
            this.durationUs = part.relativeStartTimeUs + part.durationUs;
        } else if (!list2.isEmpty()) {
            Segment segment = (Segment) C4706d0.m21756c(list2);
            this.durationUs = segment.relativeStartTimeUs + segment.durationUs;
        } else {
            this.durationUs = 0;
        }
        this.startOffsetUs = j == C6540C.TIME_UNSET ? -9223372036854775807L : j >= 0 ? j : this.durationUs + j;
    ...
    public static final class Segment extends SegmentBase {
        ...
        public Segment(String str, long j, long j2, String str2, String str3) {
            this(str, (Segment) null, "", 0, -1, C6540C.TIME_UNSET, (DrmInitData) null, str2, str3, j, j2, false, C4766t.m21978E());
        }
        ...
        public Segment(String str, Segment segment, String str2, long j, int i, long j2, DrmInitData drmInitData, String str3, String str4, long j3, long j4, boolean z, List<Part> list) {
            ...
            this.title = str2;
            this.parts = C4766t.m21988y(list);
        }
    }
}
