...
public final class C9952x2 extends C9923u3 {

    /* renamed from: c */
    private final C9932v2 f46846c;

    /* renamed from: d */
    private boolean f46847d;

    C9952x2(C4670h4 h4Var) {
        super(h4Var);
        Context r = this.f21269a.mo19277r();
        this.f21269a.mo19392z();
        this.f46846c = new C9932v2(this, r, "google_app_measurement_local.db");
    }
    ...
    private final boolean m45432x(int r17, byte[] r18) {
        /*
            r16 = this;
            r1 = r16
            r16.mo19272b()
            boolean r0 = r1.f46847d
            r2 = 0
        ...
        L_0x0028:
            ...
            r7 = 1
            r8 = 0
            android.database.sqlite.SQLiteDatabase r9 = r16.mo39257n()     // Catch:{ SQLiteFullException -> 0x00fb, SQLiteDatabaseLockedException -> 0x00e9, SQLiteException -> 0x00c2, all -> 0x00bf }
            if (r9 != 0) goto L_0x0035
            r1.f46847d = r7     // Catch:{ SQLiteFullException -> 0x00bb, SQLiteDatabaseLockedException -> 0x00ea, SQLiteException -> 0x00b7 }
            return r2
        L_0x0035:
        ...
        L_0x0054:
            ...
            com.google.android.gms.measurement.internal.h4 r15 = r1.f21269a     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.d3 r15 = r15.mo19276j()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.b3 r15 = r15.mo19282q()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            java.lang.String r4 = "Data loss, local db full"
            r15.mo38856a(r4)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            long r13 = r13 - r11
            r11 = 1
            long r13 = r13 + r11
            ...
            com.google.android.gms.measurement.internal.h4 r4 = r1.f21269a     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.d3 r4 = r4.mo19276j()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            com.google.android.gms.measurement.internal.b3 r4 = r4.mo19282q()     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
            ...
            r4.mo38859d(r15, r2, r7, r11)     // Catch:{ SQLiteFullException -> 0x0052, SQLiteDatabaseLockedException -> 0x00b2, SQLiteException -> 0x0050, all -> 0x004d }
        L_0x009f:
        ...
        L_0x00cf:
            com.google.android.gms.measurement.internal.h4 r2 = r1.f21269a     // Catch:{ all -> 0x011f }
            com.google.android.gms.measurement.internal.d3 r2 = r2.mo19276j()     // Catch:{ all -> 0x011f }
            com.google.android.gms.measurement.internal.b3 r2 = r2.mo19282q()     // Catch:{ all -> 0x011f }
            java.lang.String r4 = "Error writing entry to local database"
            r2.mo38857b(r4, r0)     // Catch:{ all -> 0x011f }
            r2 = 1
            r1.f46847d = r2     // Catch:{ all -> 0x011f }
        ...
        L_0x012d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C9952x2.m45432x(int, byte[]):boolean");
    }
    ...
    /* renamed from: n */
    public final SQLiteDatabase mo39257n() throws SQLiteException {
        if (this.f46847d) {
            return null;
        }
        SQLiteDatabase writableDatabase = this.f46846c.getWritableDatabase();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:47:?, code lost:
        r1.f21269a.mo19276j().mo19282q().mo38856a("Failed to load event from local database");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:49:?, code lost:
        r12.recycle();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:60:?, code lost:
        r1.f21269a.mo19276j().mo19282q().mo38856a("Failed to load user property from local database");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:75:?, code lost:
        r1.f21269a.mo19276j().mo19282q().mo38856a("Failed to load conditional user property from local database");
     */
    ...
    /* renamed from: o */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final java.util.List mo39258o(int r23) {
        /*
            r22 = this;
            r1 = r22
        ...
        L_0x001e:
            ...
            r10 = 1
            android.database.sqlite.SQLiteDatabase r15 = r22.mo39257n()     // Catch:{ SQLiteFullException -> 0x022e, SQLiteDatabaseLockedException -> 0x021b, SQLiteException -> 0x01f6, all -> 0x01f3 }
            if (r15 != 0) goto L_0x002a
            r1.f46847d = r10     // Catch:{ SQLiteFullException -> 0x01ee, SQLiteDatabaseLockedException -> 0x01ea, SQLiteException -> 0x01e5, all -> 0x01e0 }
            return r4
        L_0x002a:
        ...
        L_0x008f:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzau> r0 = com.google.android.gms.measurement.internal.zzau.CREATOR     // Catch:{ a -> 0x00c2 }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ a -> 0x00c2 }
            com.google.android.gms.measurement.internal.zzau r0 = (com.google.android.gms.measurement.internal.zzau) r0     // Catch:{ a -> 0x00c2 }
        ...
        L_0x00c0:
            ...
            goto L_0x00d5
        L_0x00c2:
            com.google.android.gms.measurement.internal.h4 r0 = r1.f21269a     // Catch:{ all -> 0x00c0 }
            com.google.android.gms.measurement.internal.d3 r0 = r0.mo19276j()     // Catch:{ all -> 0x00c0 }
            com.google.android.gms.measurement.internal.b3 r0 = r0.mo19282q()     // Catch:{ all -> 0x00c0 }
            java.lang.String r13 = "Failed to load event from local database"
            r0.mo38856a(r13)     // Catch:{ all -> 0x00c0 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x008f
        L_0x00d5:
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
        ...
        L_0x00d9:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzks> r0 = com.google.android.gms.measurement.internal.zzks.CREATOR     // Catch:{ a -> 0x00f4 }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ a -> 0x00f4 }
            com.google.android.gms.measurement.internal.zzks r0 = (com.google.android.gms.measurement.internal.zzks) r0     // Catch:{ a -> 0x00f4 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x0107
        L_0x00f2:
            r0 = move-exception
            goto L_0x010d
        L_0x00f4:
            com.google.android.gms.measurement.internal.h4 r0 = r1.f21269a     // Catch:{ all -> 0x00f2 }
            ...
            r0.mo38856a(r13)     // Catch:{ all -> 0x00f2 }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            r0 = r4
        L_0x0107:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x0111:
            ...
            android.os.Parcelable$Creator<com.google.android.gms.measurement.internal.zzab> r0 = com.google.android.gms.measurement.internal.zzab.CREATOR     // Catch:{ a -> 0x012c }
            java.lang.Object r0 = r0.createFromParcel(r12)     // Catch:{ a -> 0x012c }
            com.google.android.gms.measurement.internal.zzab r0 = (com.google.android.gms.measurement.internal.zzab) r0     // Catch:{ a -> 0x012c }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x013f
        L_0x012a:
            r0 = move-exception
            goto L_0x0146
        L_0x012c:
            com.google.android.gms.measurement.internal.h4 r0 = r1.f21269a     // Catch:{ all -> 0x012a }
            com.google.android.gms.measurement.internal.d3 r0 = r0.mo19276j()     // Catch:{ all -> 0x012a }
            com.google.android.gms.measurement.internal.b3 r0 = r0.mo19282q()     // Catch:{ all -> 0x012a }
            java.lang.String r13 = "Failed to load conditional user property from local database"
            r0.mo38856a(r13)     // Catch:{ all -> 0x012a }
            r12.recycle()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            r0 = r4
        L_0x013f:
            if (r0 == 0) goto L_0x008f
        ...
        L_0x014a:
            ...
            com.google.android.gms.measurement.internal.h4 r0 = r1.f21269a     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.d3 r0 = r0.mo19276j()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.b3 r0 = r0.mo19287w()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            java.lang.String r12 = "Skipping app launch break"
            r0.mo38856a(r12)     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            goto L_0x008f
        L_0x015e:
            com.google.android.gms.measurement.internal.h4 r0 = r1.f21269a     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.d3 r0 = r0.mo19276j()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
            com.google.android.gms.measurement.internal.b3 r0 = r0.mo19282q()     // Catch:{ SQLiteFullException -> 0x01b6, SQLiteDatabaseLockedException -> 0x01b3, SQLiteException -> 0x01af, all -> 0x01aa }
        ...
        L_0x016f:
            ...
            com.google.android.gms.measurement.internal.h4 r0 = r1.f21269a     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            com.google.android.gms.measurement.internal.d3 r0 = r0.mo19276j()     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            com.google.android.gms.measurement.internal.b3 r0 = r0.mo19282q()     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
            java.lang.String r12 = "Fewer entries removed from local database than expected"
            r0.mo38856a(r12)     // Catch:{ SQLiteFullException -> 0x01a7, SQLiteDatabaseLockedException -> 0x01ec, SQLiteException -> 0x01a5, all -> 0x01a3 }
        L_0x0196:
        ...
        L_0x0204:
            com.google.android.gms.measurement.internal.h4 r12 = r1.f21269a     // Catch:{ all -> 0x024c }
            com.google.android.gms.measurement.internal.d3 r12 = r12.mo19276j()     // Catch:{ all -> 0x024c }
            com.google.android.gms.measurement.internal.b3 r12 = r12.mo19282q()     // Catch:{ all -> 0x024c }
            r12.mo38857b(r3, r0)     // Catch:{ all -> 0x024c }
            r1.f46847d = r10     // Catch:{ all -> 0x024c }
        ...
        L_0x0269:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.measurement.internal.C9952x2.mo39258o(int):java.util.List");
    }

    /* renamed from: p */
    public final void mo39259p() {
        int delete;
        mo19272b();
        try {
            SQLiteDatabase n = mo39257n();
            if (n != null && (delete = n.delete("messages", (String) null, (String[]) null)) > 0) {
                this.f21269a.mo19276j().mo19286v().mo38857b("Reset local analytics data. records", Integer.valueOf(delete));
            }
        } catch (SQLiteException e) {
            this.f21269a.mo19276j().mo19282q().mo38857b("Error resetting local analytics data. error", e);
        }
    }

    /* renamed from: q */
    public final boolean mo39260q() {
        return m45432x(3, new byte[0]);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: s */
    public final boolean mo39261s() {
        Context r = this.f21269a.mo19277r();
        this.f21269a.mo19392z();
        return r.getDatabasePath("google_app_measurement_local.db").exists();
    }

    /* renamed from: t */
    public final boolean mo39262t() {
        mo19272b();
        if (!this.f46847d && mo39261s()) {
            int i = 0;
            int i2 = 5;
            while (i < 5) {
                ...
                try {
                    ...
                    this.f21269a.mo19276j().mo19282q().mo38857b("Error deleting app launch break from local database", e);
                    this.f46847d = true;
                    ...
                    this.f21269a.mo19276j().mo19282q().mo38857b("Error deleting app launch break from local database", e2);
                    this.f46847d = true;
                    if (sQLiteDatabase != null) {
                        sQLiteDatabase.close();
                        i++;
            ...
            this.f21269a.mo19276j().mo19287w().mo38856a("Error deleting app launch break from local database in reasonable time");
        }
        return false;
    }

    /* renamed from: u */
    public final boolean mo39263u(zzab zzab) {
        byte[] c0 = this.f21269a.mo19372N().mo19312c0(zzab);
        if (c0.length <= 131072) {
            return m45432x(2, c0);
        }
        this.f21269a.mo19276j().mo19284t().mo38856a("Conditional user property too long for local database. Sending directly to service");
        return false;
    }

    /* renamed from: v */
    public final boolean mo39264v(zzau zzau) {
        Parcel obtain = Parcel.obtain();
        C9890r.m45331a(zzau, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m45432x(0, marshall);
        }
        this.f21269a.mo19276j().mo19284t().mo38856a("Event is too long for local database. Sending event directly to service");
        return false;
    }

    /* renamed from: w */
    public final boolean mo39265w(zzks zzks) {
        Parcel obtain = Parcel.obtain();
        C9720a9.m45000a(zzks, obtain, 0);
        byte[] marshall = obtain.marshall();
        obtain.recycle();
        if (marshall.length <= 131072) {
            return m45432x(1, marshall);
        }
        this.f21269a.mo19276j().mo19284t().mo38856a("User property too long for local database. Sending directly to service");
        return false;
    }
}
