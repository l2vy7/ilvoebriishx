...
public final class wd0 extends yc0 {
    ...
    /* renamed from: b */
    private final Adapter f40754b;

    /* renamed from: c */
    private final uj0 f40755c;

    wd0(Adapter adapter, uj0 uj0) {
        this.f40754b = adapter;
        this.f40755c = uj0;
    }
    ...
    public final void mo34067Q4(yj0 yj0) throws RemoteException {
        uj0 uj0 = this.f40755c;
        if (uj0 != null) {
            uj0.mo33505w0(C10489b.m48195m6(this.f40754b), new zzces(yj0.zzf(), yj0.zze()));
        }
    }
    ...
    public final void mo34070d() throws RemoteException {
        uj0 uj0 = this.f40755c;
        if (uj0 != null) {
            uj0.mo33503g0(C10489b.m48195m6(this.f40754b));
        }
    }
    ...
    public final void mo34073k(int i) throws RemoteException {
        uj0 uj0 = this.f40755c;
        if (uj0 != null) {
            uj0.zzg(C10489b.m48195m6(this.f40754b), i);
        }
    }
    ...
    public final void mo34074n() throws RemoteException {
        uj0 uj0 = this.f40755c;
        if (uj0 != null) {
            uj0.mo33501A5(C10489b.m48195m6(this.f40754b));
        }
    }
    ...
    public final void zze() throws RemoteException {
        uj0 uj0 = this.f40755c;
        if (uj0 != null) {
            uj0.zze(C10489b.m48195m6(this.f40754b));
        }
    }
    ...
    public final void zzf() throws RemoteException {
        uj0 uj0 = this.f40755c;
        if (uj0 != null) {
            uj0.mo33506y(C10489b.m48195m6(this.f40754b));
        }
    }
    ...
    public final void zzo() throws RemoteException {
        uj0 uj0 = this.f40755c;
        if (uj0 != null) {
            uj0.mo33504v(C10489b.m48195m6(this.f40754b));
        }
    }
    ...
    public final void zzp() throws RemoteException {
        uj0 uj0 = this.f40755c;
        if (uj0 != null) {
            uj0.zzj(C10489b.m48195m6(this.f40754b));
        }
    }
