...
public class BottomAppBar extends Toolbar implements CoordinatorLayout.C0578b {
    ...
    public BottomAppBar(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        /*
            ...
            int r1 = p194c6.C6532l.f26828U
            android.content.res.ColorStateList r1 = p233m6.C10805c.m48753a(r8, r0, r1)
            int r2 = p194c6.C6532l.f26838V
            int r2 = r0.getDimensionPixelSize(r2, r7)
            int r3 = p194c6.C6532l.f26868Y
            int r3 = r0.getDimensionPixelOffset(r3, r7)
            float r3 = (float) r3
            int r4 = p194c6.C6532l.f26878Z
            int r4 = r0.getDimensionPixelOffset(r4, r7)
            float r4 = (float) r4
            int r5 = p194c6.C6532l.f26889a0
            int r5 = r0.getDimensionPixelOffset(r5, r7)
            float r5 = (float) r5
            int r9 = p194c6.C6532l.f26848W
            int r9 = r0.getInt(r9, r7)
            r10.f47292U = r9
            int r9 = p194c6.C6532l.f26858X
            int r9 = r0.getInt(r9, r7)
            r10.f47293V = r9
            int r9 = p194c6.C6532l.f26900b0
            boolean r9 = r0.getBoolean(r9, r7)
            r10.f47294W = r9
            int r9 = p194c6.C6532l.f26911c0
            boolean r9 = r0.getBoolean(r9, r7)
            r10.f47295l0 = r9
            int r9 = p194c6.C6532l.f26922d0
            boolean r9 = r0.getBoolean(r9, r7)
            r10.f47296m0 = r9
            int r9 = p194c6.C6532l.f26933e0
            boolean r7 = r0.getBoolean(r9, r7)
            r10.f47297n0 = r7
            r0.recycle()
            android.content.res.Resources r0 = r10.getResources()
            int r7 = p194c6.C6524d.mtrl_bottomappbar_fabOffsetEndMode
            int r0 = r0.getDimensionPixelOffset(r7)
            r10.f47288Q = r0
            com.google.android.material.bottomappbar.a r0 = new com.google.android.material.bottomappbar.a
            r0.<init>(r3, r4, r5)
            p6.m$b r3 = p243p6.C10897m.m48992a()
            ...
            float r0 = (float) r2
            r10.setElevation(r0)
            p063d0.C5135a.m23415o(r11, r1)
            p111m0.C5723u.m25336r0(r10, r11)
