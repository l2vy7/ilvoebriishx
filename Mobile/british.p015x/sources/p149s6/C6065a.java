...
abstract class C6065a<T> implements Iterator<T> {
    ...
    static /* synthetic */ class C6066a {
        ...
        static {
            /*
                s6.a$b[] r0 = p149s6.C6065a.C6067b.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f25252a = r0
                s6.a$b r1 = p149s6.C6065a.C6067b.READY     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f25252a     // Catch:{ NoSuchFieldError -> 0x001d }
                s6.a$b r1 = p149s6.C6065a.C6067b.DONE     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: p149s6.C6065a.C6066a.<clinit>():void");
        }
    }
