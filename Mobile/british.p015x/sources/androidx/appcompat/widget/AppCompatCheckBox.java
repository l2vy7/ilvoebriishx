...
public class AppCompatCheckBox extends CheckBox implements C0626l, C5722t {

    /* renamed from: b */
    private final C0380e f1207b;

    /* renamed from: c */
    private final C0378d f1208c;

    /* renamed from: d */
    private final C0399l f1209d;

    public AppCompatCheckBox(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C5238a.f22822r);
    }

    /* access modifiers changed from: protected */
    public void drawableStateChanged() {
        super.drawableStateChanged();
        C0378d dVar = this.f1208c;
        if (dVar != null) {
            dVar.mo2067b();
        }
        C0399l lVar = this.f1209d;
        if (lVar != null) {
            lVar.mo2184b();
        }
    }
