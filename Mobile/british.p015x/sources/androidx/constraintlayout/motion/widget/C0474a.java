...
public class C0474a {
    /* renamed from: a */
    public static String m2599a() {
        StackTraceElement stackTraceElement = new Throwable().getStackTrace()[1];
        return ".(" + stackTraceElement.getFileName() + ":" + stackTraceElement.getLineNumber() + ")";
    }

    /* renamed from: b */
    public static String m2600b(Context context, int i) {
        if (i == -1) {
            return "UNKNOWN";
        }
        try {
    ...
    /* renamed from: c */
    public static String m2601c(View view) {
        try {
    ...
    /* renamed from: d */
    public static String m2602d(MotionLayout motionLayout, int i) {
        if (i == -1) {
            return "UNDEFINED";
        }
    ...
    /* renamed from: e */
    public static void m2603e(String str, String str2, int i) {
